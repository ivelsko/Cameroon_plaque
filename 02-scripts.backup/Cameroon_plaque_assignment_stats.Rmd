...
ggsave("./06-publication/supplemental_figures/SXX4_malt_assignments_pct.pdf", plot = malt_pct_plot, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX4_malt_assignments_pct.png", plot = malt_pct_plot, device = "png",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)
