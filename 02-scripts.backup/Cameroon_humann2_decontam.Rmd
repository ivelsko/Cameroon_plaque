...
# plot the PCA
plot_pca(humann2_path_allsamples.pca, "PC1", "PC2", "Ethnic_Group", "Ethnic_Group", "Ethnic_Group")
...
path_curve_HG <- pathway_abundance_curves(species_orders, "HunterGatherer", "Hunter Gatherer - HUMAnN2 Paths")
...
contaminants_h2_path <- cont_prev_species_list %>% rownames_to_column("Pathway") %>% select(Pathway) # this uses the prevalence method contaminant list
...
h2path_decontam_curve_HG <- h2path_decontam_abundance_curves(h2path_decontam_orders, "HunterGatherer", "HG, decontam")
...
path_curve_HG <- pathway_abundance_curves(species_orders, "HunterGatherer", "Hunter Gatherer - KEGG Orthologs")
...
contaminants_h2_KO <- cont_prev_species_list %>% rownames_to_column("Ortholog") %>% select(Ortholog) # this uses the prevalence method contaminant list
...
save(humann2_path, humann2_path.decontam, humann2_KOs_full, humann2_KO.decontam,
