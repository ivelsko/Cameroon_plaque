...
adonis(malt_species.decontam_filtered_noblanks_noyanomami.euc ~ Industry + Tooth_site + Ethnic_Group + Age_group + Market_economy + Village + ExtractionBatch + LibraryBatch, metadata_noblanks, perm=999)
...
# test for difference between different metadata categories 
adonis(malt_species.decontam_filtered_cmc.euc ~ Tooth_site + Ethnic_Group + Market_economy + Sex + Village + Age_group + ExtractionBatch + LibraryBatch, metadata_cmc, perm=999)
...
# test for difference between different metadata categories 
adonis(malt_genus.decontam_filtered_cmc.euc ~ Tooth_site  + Ethnic_Group + Age_group + Sex + Village + Market_economy + ExtractionBatch + LibraryBatch, metadata_cmc, perm=999)
