...
# by Description (do the HMP supragingival plaque and HMP subgingival plaque samples separate?)
plot_pca_titles(malt_species.decontam_filtered_cmc, "PC1", "PC2", "Tooth_site", "Description", "Description", 3)
plot_pca_titles(malt_species.decontam_filtered_cmc, "PC3", "PC2", "Tooth_site", "Description", "Description", 3)
...
# by Description (do the HMP supragingival plaque and HMP subgingival plaque samples separate?)
plot_pca_titles(malt_genus.decontam_filtered_cmc, "PC1", "PC2", "Tooth_site", "Description", "Description", 3)
plot_pca_titles(malt_genus.decontam_filtered_cmc, "PC3", "PC2", "Tooth_site", "Description", "Description", 3)
...
pca_malt_genus_pc1pc2 <- ggplot(malt_genus.decontam_filtered_cmc.pca.varmet, aes(PC1, PC2, colour = Individual_Seq_Depth_NonHuman, shape = Ethnic_Group)) +
  geom_point(size = 4) +
  scale_shape_manual(values = Description_shapes) +
