...
pca_species_pc1pc2 <- ggplot(species.pca.varmet, aes(PC1, PC2, colour = Env, shape = Env)) +
  ...
  ylab(paste("PC2 - ", round(species.pca$explained_variance[2], 2), sep = "")) +
  theme_minimal(base_size = 14) +
  ggtitle(paste('MALT - filtered', malt_species_filtered %>%
                                     rownames_to_column("SampleID") %>%
                                     gather("Species","Counts",2:ncol(.)) %>%
                                     spread(SampleID, Counts) %>%
                                     count, 'species'))
...
pca_species_pc3pc2 <- ggplot(species.pca.varmet, aes(PC3, PC2, colour = Env, shape = Env)) +
  geom_point(size = 4) +
  scale_colour_manual(values = Env_colors) +
  scale_shape_manual(values = Env_shapes) +
  xlab(paste("PC3 - ", round(species.pca$explained_variance[3], 2), sep = "")) +
  ylab(paste("PC2 - ", round(species.pca$explained_variance[2], 2), sep = "")) +
  theme_minimal(base_size = 14) +
  ggtitle(paste('MALT - filtered', malt_species_filtered %>%
                                     rownames_to_column("SampleID") %>%
...
pca_species.decontam_pc1pc2 <- ggplot(species.decontam.pca.varmet, aes(PC1, PC2, colour = Env, shape = Env)) +
  ...
  theme_minimal(base_size = 14) +
  ggtitle(paste('MALT - decontam only', malt_species.decontam_unfilt %>%
                                     rownames_to_column("SampleID") %>%
                                     gather("Species","Counts",2:ncol(.)) %>%
                                     spread(SampleID, Counts) %>%
                                     count, 'species'))
...
pca_species.decontam_filtered_pc1pc2 <- ggplot(species.decontam_filtered.pca.varmet, aes(PC1, PC2, colour = Env, shape = Env)) +
  ...
  theme_minimal(base_size = 14) +
  ggtitle(paste('MALT - decontam filtered', malt_species.decontam_filtered %>%
                                     rownames_to_column("SampleID") %>%
                                     gather("Species","Counts",2:ncol(.)) %>%
                                     spread(SampleID, Counts) %>%
                                     count, 'species'))
...
pca_species.decontam_filtered_pc3pc2 <- ggplot(species.decontam_filtered.pca.varmet, aes(PC3, PC2, colour = Env, shape = Env)) +
  geom_point(size = 4) +
  scale_colour_manual(values = Env_colors) +
  scale_shape_manual(values = Env_shapes) +
  xlab(paste("PC3 - ", round(species.decontam_filtered.pca$explained_variance[3], 2), sep = "")) +
  ylab(paste("PC2 - ", round(species.decontam_filtered.pca$explained_variance[2], 2), sep = "")) +
  theme_minimal(base_size = 14) +
  ggtitle(paste('MALT - decontam filtered', malt_species.decontam_filtered %>%
                                     rownames_to_column("SampleID") %>%
...
pca_species.decontam_filtered_pc3pc2
...
#   ylab(paste("PC2 - ", round(species.decontam_filtered.pca$explained_variance[2], 2), sep = "")) +
#   theme_minimal(base_size = 14) +
#   ggtitle('MALT - decontam and filtered')
# 
# pca_species.decontam_filtered_pc1pc2
...
pca_nt_genus_pc1pc2 <- ggplot(nt_genus.pca.varmet, aes(PC1, PC2, colour = Env, shape = Env)) +
  ...
  theme_minimal(base_size = 14) +
  ggtitle(paste('MALT - filtered', malt_genus_unfiltered %>%
                                     rownames_to_column("SampleID") %>%
                                     gather("Species","Counts",2:ncol(.)) %>%
                                     spread(SampleID, Counts) %>%
                                     count, 'genera'))
...
pca_nt_genus_pc1pc2 <- ggplot(nt_genus.pca.varmet, aes(PC1, PC2, colour = Env, shape = Env)) +
  ...
  ylab(paste("PC2 - ", round(nt_genus.pca$explained_variance[2], 2), sep = "")) +
  theme_minimal(base_size = 14) +
  ggtitle(paste('MALT - filtered', malt_genus_filtered %>%
                                     rownames_to_column("SampleID") %>%
                                     gather("Species","Counts",2:ncol(.)) %>%
                                     spread(SampleID, Counts) %>%
                                     count, 'genera'))
...
# perform a PCA to see how the data cluster
nt_genus.decontam.pca <- mixOmics::pca(malt_genus.decontam_unfiltered, ncomp = 3, logratio = 'CLR')
...
pca_nt_genus.decontam_pc1pc2 <- ggplot(nt_genus.decontam.pca.varmet, aes(PC1, PC2, colour = Env, shape = Env)) +
  ...
  theme_minimal(base_size = 14) +
  ggtitle(paste('MALT - decontam filtered', malt_genus.decontam_unfiltered %>%
                                     rownames_to_column("SampleID") %>%
                                     gather("Species","Counts",2:ncol(.)) %>%
                                     spread(SampleID, Counts) %>%
                                     count, 'genera'))
...
pca_nt_genus.decontam_pc1pc2 <- ggplot(nt_genus.decontam.pca.varmet, aes(PC1, PC2, colour = Env, shape = Env)) +
  ...
  ylab(paste("PC2 - ", round(nt_genus.decontam.pca$explained_variance[2], 2), sep = "")) +
  theme_minimal(base_size = 14) +
  ggtitle(paste('MALT - decontam filtered', malt_genus.decontam_filtered %>%
                                     rownames_to_column("SampleID") %>%
                                     gather("Species","Counts",2:ncol(.)) %>%
                                     spread(SampleID, Counts) %>%
                                     count, 'genera'))
...
pca_nt_genus.decontam_pc3pc2 <- ggplot(nt_genus.decontam.pca.varmet, aes(PC3, PC2, colour = Env, shape = Env)) +
  geom_point(size = 4) +
  scale_colour_manual(values = Env_colors) +
  scale_shape_manual(values = Env_shapes) +
  xlab(paste("PC3 - ", round(nt_genus.decontam.pca$explained_variance[3], 2), sep = "")) +
  ylab(paste("PC2 - ", round(nt_genus.decontam.pca$explained_variance[2], 2), sep = "")) +
  theme_minimal(base_size = 14) +
  ggtitle(paste('MALT - decontam filtered', malt_genus.decontam_filtered %>%
                                     rownames_to_column("SampleID") %>%
