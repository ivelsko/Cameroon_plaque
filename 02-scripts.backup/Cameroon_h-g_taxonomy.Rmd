...
# malt_species.decontamL_EG$Env <- factor(malt_species.decontamL_EG$Env, levels = c("HunterGatherer","ExtractionGauze","ExtractionBlank","LibraryBlank"))
...
malt_species.decontamL_LB_plot <- malt_species.decontamL_LB %>%
     ...
     ylab("mean relative abundance") +
     xlab("species order") +
     ggtitle("Library Blank")

plot_grid(malt_species.decontamL_HG_plot, malt_species.decontamL_EG_plot,
          malt_species.decontamL_EB_plot, malt_species.decontamL_LB_plot,
...
# malt_genus.decontamL_LB$Env <- factor(malt_genus.decontamL_LB$Env, levels = c("HunterGatherer","ExtractionGauze","ExtractionBlank","LibraryBlank"))
...
plot_grid(malt_genus.decontamL_HG_plot, malt_genus.decontamL_EG_plot,
          malt_genus.decontamL_EB_plot, malt_genus.decontamL_LB_plot,
          nrow=2, labels = c("A", "B", "C", "D"), rel_widths = c(1, 1))
