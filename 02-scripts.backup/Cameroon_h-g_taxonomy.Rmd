...
test_plot_1 <- plot_box_whisker(maltnt_assignments, "Percent", "Env", "Env", "Percent of reads assigned by MALT with nt2017")
test_plot_1
...
malt_species.decontamL_JAE <- malt_species.decontamL %>%
  filter(str_detect(Env, "JAE")) %>%
  filter(!str_detect(Env, "JAE10")) %>%
  group_by(Species) %>%
  summarise(mean_relab = mean(Relab)) %>%
  arrange(desc(mean_relab)) %>%
  filter(mean_relab > 0) %>%
...
malt_species.decontamL_JAE10 <- malt_species.decontamL %>%
  filter(str_detect(Env, "JAE10")) %>%
  group_by(Species) %>%
  summarise(mean_relab = mean(Relab)) %>%
  arrange(desc(mean_relab)) %>%
...
malt_species.decontamL_JAE_plot <- malt_species.decontamL_JAE%>%
     ggplot(., aes(x=order, y=mean_relab)) +
     geom_point() +
     theme_minimal() +
     geom_hline(yintercept=0.01, linetype="dashed", color = "red") +
     ...
     ylab("mean relative abundance") +
     xlab("species order") +
     ggtitle("JAE full set - species")

malt_species.decontamL_JAE10M_plot <- malt_species.decontamL_JAE10 %>%
     ggplot(., aes(x=order, y=mean_relab)) +
     geom_point() +
     theme_minimal() +
     geom_hline(yintercept=0.01, linetype="dashed", color = "red") +
     ...
     ylab("mean relative abundance") +
     xlab("species order") +
     ggtitle("JAE 10M - species")

plot_grid(malt_species.decontamL_HG_plot, malt_species.decontamL_HMP_plot, malt_species.decontamL_HMP10M_plot, malt_species.decontamL_JAE_plot,
          malt_species.decontamL_JAE10M_plot, malt_species.decontamL_EG_plot,malt_species.decontamL_EB_plot, malt_species.decontamL_LB_plot,
...
malt_genus.decontamL_JAE <- malt_genus.decontamL %>%
  filter(str_detect(Env, "JAE")) %>%
  filter(!str_detect(Env, "JAE10")) %>%
  group_by(Species) %>%
  summarise(mean_relab = mean(Relab)) %>%
...
malt_genus.decontamL_JAE10M <- malt_genus.decontamL %>%
  filter(str_detect(Env, "JAE10")) %>%
  group_by(Species) %>%
  summarise(mean_relab = mean(Relab)) %>%
  arrange(desc(mean_relab)) %>%
...
malt_genus.decontamL_JAE_plot <- malt_genus.decontamL_JAE %>%
     ggplot(., aes(x=order, y=mean_relab)) +
     geom_point() +
     theme_minimal() +
     scale_y_log10() +
     ...
     ylab("mean relative abundance") +
     xlab("genus order") +
     ggtitle("JAE full set - genus")

malt_genus.decontamL_JAE10M_plot <- malt_genus.decontamL_JAE10M %>%
     ggplot(., aes(x=order, y=mean_relab)) +
     geom_point() +
     theme_minimal() +
     scale_y_log10() +
     ...
     ylab("mean relative abundance") +
     xlab("genus order") +
     ggtitle("JAE 10M - genus")

plot_grid(malt_genus.decontamL_HG_plot, malt_genus.decontamL_HMP_plot, malt_genus.decontamL_HMP10M_plot, malt_genus.decontamL_JAE_plot,
          malt_genus.decontamL_JAE10M_plot, malt_genus.decontamL_EG_plot,malt_genus.decontamL_EB_plot, malt_genus.decontamL_LB_plot,
          nrow=2, labels = c("A", "B", "C", "D", "E", "F","G","H"), rel_widths = c(1, 1))
