...
songbird multinomial \
	        --input-biom /projects1/microbiome_calculus/Cameroon_plaque/05-results.backup/malt_genus_cmc_decontam.biom \
		...
		--formula "C(Sex, Treatment('Male'))" \
	        ...
	        --summary-interval 1 \
	        --summary-dir /projects1/microbiome_calculus/Cameroon_plaque/04-analysis/songbird/genus_cmc/form4
