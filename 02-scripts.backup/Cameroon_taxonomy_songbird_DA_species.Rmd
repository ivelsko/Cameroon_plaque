...
songbird_cmc_species_eg <- fread("./05-results.backup/songbird_noblanks_species_eg.tsv")
songbird_cmc_species_me <- fread("./05-results.backup/songbird_noblanks_species_me.tsv")
songbird_cmc_species_ts <- fread("./05-results.backup/songbird_noblanks_species_ts.tsv")
songbird_cmc_species_sex <- fread("./05-results.backup/songbird_noblanks_species_sex.tsv")
