...
# perform and plot a PCA to see how the data cluster
all_samples_gn_pca12 <- plot_pca_titles(malt_genus.decontam_filtered, "PC1", "PC2", "Description", "Env", "Env", 3)
all_samples_gn_pca12
all_samples_gn_pca32 <- plot_pca_titles(malt_genus.decontam_filtered, "PC3", "PC2", "Description", "Env", "Env", 3)
all_samples_gn_pca32

ggsave("./06-publication/supplemental_figures/SXX28/SXX28_all_samples_gn_pca12.pdf", plot = all_samples_gn_pca12, device = "pdf",
       scale = 1, width = 6, height = 7, units = c("in"), dpi = 300)
ggsave("./06-publication/supplemental_figures/SXX28/SXX28_all_samples_gn_pca32.pdf", plot = all_samples_gn_pca32, device = "pdf",
       scale = 1, width = 6, height = 7, units = c("in"), dpi = 300)
...
# perform and plot a PCA to see how the data cluster
# by Village
pca_yanomami_12 <- plot_pca_titles(malt_species.decontam_filtered_noblanks, "PC1", "PC2", "Village", "Ethnic_Group", "Ethnic_Group", 3)
pca_yanomami_12
pca_yanomami_32 <- plot_pca_titles(malt_species.decontam_filtered_noblanks, "PC3", "PC2", "Village", "Ethnic_Group", "Ethnic_Group", 3)
pca_yanomami_32

ggsave("./06-publication/supplemental_figures/SXX28/SXX28_noblanks_sp_pca12.pdf", plot = pca_yanomami_12, device = "pdf",
       scale = 1, width = 6, height = 7, units = c("in"), dpi = 300)
ggsave("./06-publication/supplemental_figures/SXX28/SXX28_noblanks_sp_pca32.pdf", plot = pca_yanomami_32, device = "pdf",
       scale = 1, width = 6, height = 7, units = c("in"), dpi = 300)
...
# by Market economy
species_me_pc12 <- plot_pca_titles(malt_species.decontam_filtered_noblanks_mr, "PC1", "PC2", "Market_economy", "Ethnic_Group", "Ethnic_Group", 3)
species_me_pc12
plot_pca_titles(malt_species.decontam_filtered_noblanks_mr, "PC3", "PC2", "Market_economy", "Ethnic_Group", "Ethnic_Group", 3)

ggsave("../06-publication/supplemental_figures/SXX35/panel_parts/SXX35_species_me_pc12.pdf", plot = species_me_pc12,
       device = "pdf", scale = 1, width = 6, height = 7, units = c("in"), dpi = 300)
...
```{r biplot_noblanks_noyanomami_species, eval = F}
...
adonis2(malt_species.decontam_filtered_noblanks_mr.euc ~ ExtractionBatch +  LibraryBatch, metadata_noblanks, permutations = 999, by = "margin")
adonis2(malt_species.decontam_filtered_noblanks_mr.euc ~ Village + Sex + Industry + Tooth_site + Ethnic_Group + Age_group + Market_economy, metadata_noblanks, permutations = 999, by = "margin")

# test for difference between different metadata categories excluding Village, which influences Ethnic_Group, Industry, and Market_economy
# this still has Ethnic_Group and Indistry as -Inf
adonis2(malt_species.decontam_filtered_noblanks_mr.euc ~ Sex + Industry + Tooth_site + Ethnic_Group + Age_group + Market_economy, metadata_noblanks, permutations = 999, by = "margin")

# controlled for tooth site
adonis2(malt_species.decontam_filtered_noblanks_mr.euc ~ Village + Sex + Industry + Ethnic_Group + Age_group +  Market_economy, metadata_noblanks, permutations = 999, by = "margin", strata = metadata_noblanks$Tooth_site)
...
ggsave("../06-publication/supplemental_figures/SXX35/panel_parts/SXX35_species_cmc_sex_pc12.pdf", plot = species_sex_pc12,
       device = "pdf", scale = 1, width = 7, height = 9, units = c("in"), dpi = 300)
...
# by Market economy
species_me_pc12 <- plot_pca_titles(malt_species.decontam_filtered_cmc_mr, "PC1", "PC2", "Market_economy", "Ethnic_Group", "Ethnic_Group", 3)
species_me_pc12
...
adonis2(malt_species.decontam_filtered_cmc.euc ~ Village + Sex + Tooth_site + Ethnic_Group + Age_group +  Market_economy, metadata_cmc, permutations = 999, by = "margin")

# controlled for tooth site
adonis2(malt_species.decontam_filtered_cmc.euc ~ Village + Sex + Ethnic_Group + Age_group +  Market_economy, metadata_cmc, permutations = 999, by = "margin", strata = metadata_cmc$Tooth_site)
...
Filter the genus table by just the genera in MR1 from
...
# by Sex
genus_sex_pc12 <- plot_pca_titles(malt_genus.decontam_filtered_noblanks_mr, "PC1", "PC2", "Sex", "Ethnic_Group", "Ethnic_Group", 3)
genus_sex_pc12
plot_pca_titles(malt_genus.decontam_filtered_noblanks_mr, "PC3", "PC2", "Sex", "Ethnic_Group", "Ethnic_Group", 3)

ggsave("../06-publication/supplemental_figures/SXX36/panel_parts/SXX36_genus_sex_pc12.pdf", plot = genus_sex_pc12,
       device = "pdf", scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

# by Age group
genus_age_pc12 <- plot_pca_titles(malt_genus.decontam_filtered_noblanks_mr, "PC1", "PC2", "Age_group", "Ethnic_Group", "Ethnic_Group", 3)
genus_age_pc12
plot_pca_titles(malt_genus.decontam_filtered_noblanks_mr, "PC3", "PC2", "Age_group", "Ethnic_Group", "Ethnic_Group", 3)

ggsave("../06-publication/supplemental_figures/SXX36/panel_parts/SXX36_genus_age_pc12.pdf", plot = genus_age_pc12,
       device = "pdf", scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

# by Market economy
genus_me_pc12 <- plot_pca_titles(malt_genus.decontam_filtered_noblanks_mr, "PC1", "PC2", "Market_economy", "Ethnic_Group", "Ethnic_Group", 3)
genus_me_pc12
plot_pca_titles(malt_genus.decontam_filtered_noblanks_mr, "PC3", "PC2", "Market_economy", "Ethnic_Group", "Ethnic_Group", 3)

ggsave("../06-publication/supplemental_figures/SXX36/panel_parts/SXX36_genus_me_pc12.pdf", plot = genus_me_pc12,
       device = "pdf", scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)
...
```{r biplot_samples_no_yanomami_genus, eval = F}
...
Now biplots from the PCA with only MR1 proteins from the factor analysis
```{r biplot_samples_no_yanomami_genus_mr1}
...
# Now plot biplots, and make tables of the top 10 species in each loading
malt_genus_decontam_filtered_noyanomami_biplot_121 <- plot_pca_bi(malt_genus.decontam_filtered_noblanks_mr.pca, "PC1", "PC2", "Ethnic_Group", PC1)
malt_genus_decontam_filtered_noyanomami_biplot_121

ggsave("../06-publication/supplemental_figures/SXX19/panel_parts/SXX19_genus_all_biplot_121.pdf", plot = malt_genus_decontam_filtered_noyanomami_biplot_121,
       device = "pdf", scale = 1, width = 6, height = 7, units = c("in"), dpi = 300)
...
malt_genus_decontam_filtered_noyanomami_biplot_122 <- plot_pca_bi(malt_genus.decontam_filtered_noblanks_mr.pca, "PC1", "PC2", "Ethnic_Group", PC2)
malt_genus_decontam_filtered_noyanomami_biplot_122
...
malt_genus_decontam_filtered_noyanomami_biplot_322 <- plot_pca_bi(malt_genus.decontam_filtered_noblanks_mr.pca, "PC3", "PC2", "Ethnic_Group", PC2)
malt_genus_decontam_filtered_noyanomami_biplot_322

malt_genus_decontam_filtered_noyanomami_biplot_323 <- plot_pca_bi(malt_genus.decontam_filtered_noblanks_mr.pca, "PC3", "PC2", "Ethnic_Group", PC3)
malt_genus_decontam_filtered_noyanomami_biplot_323
...
```
The genera are quite different between the abundance filtered table and the MR1 genera. 
...
# Euclidean distance
malt_genus.decontam_filtered_noblanks_noyanomami.euc <- vegdist(malt_genus.decontam_filtered_noblanks_mr.pca$X, method = "euclidean", na.rm = T)
...
# test for difference between different metadata categories 
adonis2(malt_genus.decontam_filtered_noblanks_noyanomami.euc ~ ExtractionBatch +  LibraryBatch, metadata_noblanks, permutations = 999, by = "margin")

adonis2(malt_genus.decontam_filtered_noblanks_noyanomami.euc ~ Village + Sex + Industry + Tooth_site + Ethnic_Group + Age_group +  Market_economy, metadata_noblanks, permutations = 999, by = "margin")

# controlled for tooth site
adonis2(malt_genus.decontam_filtered_noblanks_noyanomami.euc ~ Village + Sex + Industry + Ethnic_Group + Age_group +  Market_economy, metadata_noblanks, permutations = 999, by = "margin", strata = metadata_noblanks$Tooth_site)

```
Village and tooth site are significantly different unless controlling for tooth
site, when only village is significantly different.
...
## Calculate multivariate dispersions
village_betadisper_noblanks_noyanomami_genus <- betadisper(malt_genus.decontam_filtered_noblanks_noyanomami.euc, groups_village, bias.adjust =TRUE)
village_betadisper_noblanks_noyanomami_genus

## Perform test
anova(village_betadisper_noblanks_noyanomami_genus)

## Permutation test for F
permutest(village_betadisper_noblanks_noyanomami_genus, pairwise = TRUE, permutations = 99)

## Tukey's Honest Significant Differences
village_betadisper_noblanks_noyanomami_genus.HSD <- TukeyHSD(village_betadisper_noblanks_noyanomami_genus)
plot(village_betadisper_noblanks_noyanomami_genus.HSD)

## Plot with data ellipses instead of hulls
plot(village_betadisper_noblanks_noyanomami_genus, ellipse = TRUE, hull = FALSE) # 1 sd data ellipse

## Draw a boxplot of the distances to centroid for each group
boxplot(village_betadisper_noblanks_noyanomami_genus)

```
There is no significant difference in dispersion for tooth site groups or villages. 
...
# by Sex
genus_cmc_sex_pc12 <- plot_pca_titles(malt_genus.decontam_filtered_cmc_mr, "PC1", "PC2", "Sex", "Ethnic_Group", "Ethnic_Group", 3)
genus_cmc_sex_pc12
plot_pca_titles(malt_genus.decontam_filtered_cmc_mr, "PC3", "PC2", "Sex", "Ethnic_Group", "Ethnic_Group", 3)

ggsave("../06-publication/supplemental_figures/SXX36/panel_parts/SXX36_genus_cmc_sex_pc12.pdf", plot = genus_cmc_sex_pc12,
       device = "pdf", scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

# by Age group
genus_cmc_age_pc12 <- plot_pca_titles(malt_genus.decontam_filtered_cmc_mr, "PC1", "PC2", "Age_group", "Ethnic_Group", "Ethnic_Group", 3)
genus_cmc_age_pc12
plot_pca_titles(malt_genus.decontam_filtered_cmc_mr, "PC3", "PC2", "Age_group", "Ethnic_Group", "Ethnic_Group", 3)

ggsave("../06-publication/supplemental_figures/SXX36/panel_parts/SXX36_genus_cmc_age_pc12.pdf", plot = genus_cmc_age_pc12,
       device = "pdf", scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

# by Market economy
genus_cmc_me_pc12 <- plot_pca_titles(malt_genus.decontam_filtered_cmc_mr, "PC1", "PC2", "Market_economy", "Ethnic_Group", "Ethnic_Group", 3)
genus_cmc_me_pc12
plot_pca_titles(malt_genus.decontam_filtered_cmc_mr, "PC3", "PC2", "Market_economy", "Ethnic_Group", "Ethnic_Group", 3)

ggsave("../06-publication/supplemental_figures/SXX36/panel_parts/SXX36_genus_cmc_me_pc12.pdf", plot = genus_cmc_me_pc12,
       device = "pdf", scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)
...
# by Tooth site
extractionbatch_gn <- plot_pca_titles(malt_genus.decontam_filtered_cmc_mr, "PC1", "PC2", "ExtractionBatch", "Ethnic_Group", "Ethnic_Group", 3)
extractionbatch_gn

# by Tooth site
librarybatch_gn <- plot_pca_titles(malt_genus.decontam_filtered_cmc_mr, "PC1", "PC2", "LibraryBatch", "Ethnic_Group", "Ethnic_Group", 3)
librarybatch_gn
...
ggsave("./06-publication/supplemental_figures/SXX2/SXX2_exb_betadiv_mr1_gn.pdf", plot = extractionbatch_gn, device = "pdf",
       scale = 1, width = 6, height = 6, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX2/SXX2_lib_betadiv_mr1_gn.pdf", plot = librarybatch_gn, device = "pdf",
       scale = 1, width = 6, height = 6, units = c("in"), dpi = 300)
...
# Euclidean distance
malt_genus.decontam_filtered_cmc.euc <- vegdist(malt_genus.decontam_filtered_cmc_mr.pca$X, method = "euclidean", na.rm = T)
...
# test for difference between different metadata categories 
adonis2(malt_genus.decontam_filtered_cmc.euc ~ ExtractionBatch +  LibraryBatch, metadata_cmc, permutations = 999, by = "margin")
adonis2(malt_genus.decontam_filtered_cmc.euc ~ Village + Sex + Tooth_site + Ethnic_Group + Age_group +  Market_economy, metadata_cmc, permutations = 999, by = "margin")

# controlled for tooth site
adonis2(malt_genus.decontam_filtered_cmc.euc ~ Village + Sex + Ethnic_Group + Age_group +  Market_economy, metadata_cmc, permutations = 999, by = "margin", strata = metadata_cmc$Tooth_site)
...
```
There is a significant difference in disperson between tooth site groups, but
not between villages.

Make biplots showing the loadings of the strongest loading genera in PC1 and PC2
positive and negative directions
```{r biplots_cmc_genus, eval = F}
...
Now biplots on the PCA with only MR1 genera
```{r biplots_cmc_genus_mr}
...
malt_genus_decontam_filtered_nocontrols_biplot_121 <- plot_pca_bi(malt_genus.decontam_filtered_cmc_mr.pca, "PC1", "PC2", "Tooth_site", PC1)
malt_genus_decontam_filtered_nocontrols_biplot_121

ggsave("../06-publication/supplemental_figures/SXX19/panel_parts/SXX19_genus_cmc_biplot_121.pdf", plot = malt_genus_decontam_filtered_nocontrols_biplot_121,
       device = "pdf", scale = 1, width = 6, height = 7, units = c("in"), dpi = 300)
...
malt_genus_decontam_filtered_nocontrols_biplot_122 <- plot_pca_bi(malt_genus.decontam_filtered_cmc_mr.pca, "PC1", "PC2", "Ethnic_Group", PC2)
malt_genus_decontam_filtered_nocontrols_biplot_122
...
malt_genus_decontam_filtered_nocontrols_biplot_322 <- plot_pca_bi(malt_genus.decontam_filtered_cmc_mr.pca, "PC3", "PC2", "Ethnic_Group", PC2)
malt_genus_decontam_filtered_nocontrols_biplot_322

malt_genus_decontam_filtered_nocontrols_biplot_323 <- plot_pca_bi(malt_genus.decontam_filtered_cmc_mr.pca, "PC3", "PC2", "Ethnic_Group", PC3)
malt_genus_decontam_filtered_nocontrols_biplot_323
...
```
There is overlap in the genera that are in the top 10 of PC1 and PC2 between the
abundance filter and the MR1 genera, from 4-6 genera. Just stick with the MR1
genera
