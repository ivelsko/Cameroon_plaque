...
metadata_noblanks <- metadata_noblanks %>%
  ...
  select(SampleID, Age_group, Ethnic_Group, Env, Industry, Market_integration, Sex, Tooth_site, Village, ExtractionBatch, LibraryBatch)
...
adonis2(malt_species.decontam_filtered_noblanks_mr.euc ~ Ethnic_Group + Market_integration, metadata_noblanks, permutations = 999, by = "margin")
...
adonis2(malt_species.decontam_filtered_noblanks_mr.euc ~ Industry + Market_integration, metadata_noblanks, permutations = 999, by = "margin")
