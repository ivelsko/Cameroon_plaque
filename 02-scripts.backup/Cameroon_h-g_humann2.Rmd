...
plot_pca <- function(df, pc1, pc2, metadata_group) {
    ...
    # metadata_group = metadata$metadata_group
    ...
    pca_plot <- ggplot(df_X, aes(pc1, pc2, colour = metadata_group, shape = metadata_group)) +
                        ...
                        scale_colour_manual(values = metadata_group_shapes) +
                        # stat_ellipse() +
...
plot_pca <- function(df, pc1, pc2, metadata_group) {
    ...
    pca_plot <- ggplot(df_X, aes(df_X$pc1, df_X$pc2, colour = metadata_group, shape = metadata_group)) +
                        geom_point(size = 4) +
                        scale_colour_manual(values = metadata_group_colors) +
                        scale_colour_manual(values = metadata_group_shapes) +
                        # stat_ellipse() +
