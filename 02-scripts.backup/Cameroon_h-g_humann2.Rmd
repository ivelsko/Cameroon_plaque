...
*This section needs to be checked and re-written*The number of reads assigned in each sample appears very low (~50%). We want to check this so we know how many were assinged in each sample. We used the cleaned and merged reads that didn't align to the human genome (hg19). 
```{r load_data}
...
# plot the PCA
pca_EG_plot <- plot_pca(humann2_path_noblanks.pca, "PC1", "PC2", "Ethnic_Group")
pca_EG_plot
plot_pca(humann2_path_noblanks.pca, "PC3", "PC2", "Ethnic_Group")

pca_AG_plot <- plot_pca(humann2_path_noblanks.pca, "PC1", "PC2", "Age_group")
pca_AG_plot

pca_ME_plot <- plot_pca(humann2_path_noblanks.pca, "PC1", "PC2", "Market_economy")
pca_ME_plot

pca_S_plot <- plot_pca(humann2_path_noblanks.pca, "PC1", "PC2", "Sex")
pca_S_plot

pca_TS_plot <- plot_pca(humann2_path_noblanks.pca, "PC1", "PC2", "Tooth_site")
pca_TS_plot

pca_V_plot <- plot_pca(humann2_path_noblanks.pca, "PC1", "PC2", "Village")
pca_V_plot
...
# test for difference between different metadata categories 
adonis(humann2_path_cmc_mat.euc ~ Tooth_site, humann2_path_cmc_mat.euc.vecmet, perm=999)
...
pca_EG_biplot_pc1 <- plot_pca_bi(humann2_path_noblanks.pca, "PC1", "PC2", "Ethnic_Group", PC1, pathways = T)
pca_EG_biplot_pc1
...
# which paths distinguish sample types when HMP and JAE are included?
pca_EG_biplot_pc2 <- plot_pca_bi(humann2_path_noblanks.pca, "PC1", "PC2", "Ethnic_Group", PC2, pathways = T)
pca_EG_biplot_pc2
...
# test for difference between different metadata categories 
adonis(humann2_KO_mat.euc ~ Tooth_site, humann2_KO_mat.euc.vecmet, perm=999)
