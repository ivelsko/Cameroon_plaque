...
plot_box_whisker(malt_species.decontam_filtered.alpha, "Observed_species", "Env", "Env", "Environment")
plot_box_whisker(malt_species.decontam_filtered.alpha, "Observed_species", "Ethnic_Group", "Ethnic_Group", "Ethnic group")
plot_box_whisker(malt_species.decontam_filtered.alpha, "Observed_species", "Market_economy", "Market_economy", "Market economy")


# ggsave("05-results.backup/NoS_UKY.pdf", plot = NoS, device = "pdf",
...
plot_box_whisker(malt_genus.decontam_filtered.alpha, "Observed_genera", "Env", "Env", "Environment")
plot_box_whisker(malt_genus.decontam_filtered.alpha, "Observed_genera", "Ethnic_Group", "Ethnic_Group", "Ethnic group")
plot_box_whisker(malt_genus.decontam_filtered.alpha, "Observed_genera", "Market_economy", "Market_economy", "Market economy")
plot_box_whisker(malt_genus.decontam_filtered.alpha, "Observed_genera", "Age_group", "Age_group", "Age group")
plot_box_whisker(malt_genus.decontam_filtered.alpha, "Observed_genera", "Village", "Village", "Village")
plot_box_whisker(malt_genus.decontam_filtered.alpha, "Observed_genera", "Tooth_site", "Tooth_site", "Tooth site")
plot_box_whisker(malt_genus.decontam_filtered.alpha, "Pileou_evenness", "Tooth_site", "Tooth_site", "Tooth site")
...
plot_box_whisker(malt_species.decontam_filtered.alpha, "Shannon_index", "Sex", "Sex", "Sex")
plot_box_whisker(malt_species.decontam_filtered.alpha, "Pileou_evenness", "Sex", "Sex", "Sex")
plot_box_whisker(malt_species.decontam_filtered.alpha, "Observed_species", "Tooth_site", "Tooth_site", "Tooth site")
...
plot_box_whisker(malt_genus.decontam_filtered.alpha, "Observed_genera", "Ethnic_Group", "Ethnic_Group", "Ethnic group")
plot_box_whisker(malt_genus.decontam_filtered.alpha, "Observed_genera", "Village", "Village", "Village")
plot_box_whisker(malt_genus.decontam_filtered.alpha, "Shannon_index", "Tooth_site", "Tooth_site", "Tooth site")
plot_box_whisker(malt_genus.decontam_filtered.alpha, "Pileou_evenness", "Tooth_site", "Tooth_site", "Tooth site")
