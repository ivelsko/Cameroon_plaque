...
plot_box_whisker(malt_species.decontam_filtered.os, "Observed_species", "Env", "Env", "Number of species")
NoS <- plot_box_whisker(malt_species.decontam_filtered.os, "Observed_species", "Village", "Village", "Number of species")
...
plot_box_whisker(malt_species.decontam_filtered.shannon, "Shannon_index", "Env", "Env", "Shannon Index")
Shannon <- plot_box_whisker(malt_species.decontam_filtered.shannon, "Shannon_index", "Village", "Village", "Shannon Index")

ggsave("05-results.backup/Shannon_UKY.pdf", plot = Shannon, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"),
       dpi = 300)
