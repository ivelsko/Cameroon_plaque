...
og_plot <-malt_genus.decontam.os %>%
  inner_join(metadata %>%
               select(SampleID, Env, Description, Ethnic_Group, Age_group,
                      Sex, Market_economy, Village, Tooth_site, Type), by = "SampleID") %>%
  ggplot(., aes(x = Village, y = Observed_genera, fill = Village)) +
                         geom_boxplot() +
                         scale_fill_manual(values = Village_colors) +
                         theme_minimal(base_size = 18) +
                         #scale_y_continuous(trans='log10') +
...
ggsave("./06-publication/supplemental_figures/SXX5/SXX5_og.pdf", plot = og_plot, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)
...
shannon_gn_plot <-malt_genus.decontam.shannon %>%
  inner_join(metadata %>%
               select(SampleID, Env, Description, Ethnic_Group, Age_group,
                      Sex, Market_economy, Village, Tooth_site, Type), by = "SampleID") %>%
  ggplot(., aes(x = Village, y = Shannon_index, fill = Village)) +
...
ggsave("./06-publication/supplemental_figures/SXX5/SXX5_shannon_gn.pdf", plot = shannon_gn_plot, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)
...
names(evenness.genus)[1] <- "Pileou_evenness"

# merge with the metadata file and plot
evenness.genus <- evenness.genus %>%
  rownames_to_column("SampleID") 

plot_box_whisker(evenness.genus, "Pileou_evenness", "Env", "Env", "Pielou's evenness")
plot_box_whisker(evenness.genus, "Pileou_evenness", "Village", "Village", "Pielou's evenness")

pe_gn_plot <-evenness.genus %>%
  inner_join(metadata %>%
               select(SampleID, Env, Description, Ethnic_Group, Age_group,
                      Sex, Market_economy, Village, Tooth_site, Type), by = "SampleID") %>%
  ggplot(., aes(x = Village, y = Pileou_evenness, fill = Village)) +
...
ggsave("./06-publication/supplemental_figures/SXX5/SXX5_pe_gn.pdf", plot = pe_gn_plot, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)
...
names(evenness_filtered.genus)[1] <- "Pileou_evenness"

# merge with the metadata file and plot
evenness_filtered.genus <- evenness_filtered.genus %>%
  rownames_to_column("SampleID") 

plot_box_whisker(evenness_filtered.genus, "Pileou_evenness", "Env", "Env", "Pielou's evenness - genus")
plot_box_whisker(evenness_filtered.genus, "Pileou_evenness", "Village", "Village", "Pielou's evenness - genus")
...
os_market_split
shannon_market_split <- plot_box_whisker(malt_species.decontam_filtered.alpha, "Shannon_index", "Market_economy_split", "Market_economy_split", "Market economy")
shannon_market_split
pe_market_split <- plot_box_whisker(malt_species.decontam_filtered.alpha, "Pileou_evenness", "Market_economy_split", "Market_economy_split", "Market economy")
pe_market_split

os_age <- plot_box_whisker(malt_species.decontam_filtered.alpha, "Observed_species", "Age_group", "Age_group", "Age_group economy")
os_age
shannon_age <- plot_box_whisker(malt_species.decontam_filtered.alpha, "Shannon_index", "Age_group", "Age_group", "Age_group")
shannon_age
pe_age <- plot_box_whisker(malt_species.decontam_filtered.alpha, "Pileou_evenness", "Age_group", "Age_group", "Age_group")
pe_age

os_sex <- plot_box_whisker(malt_species.decontam_filtered.alpha, "Observed_species", "Sex", "Sex", "Sex")
os_sex
shannon_sex <- plot_box_whisker(malt_species.decontam_filtered.alpha, "Shannon_index", "Sex", "Sex", "Sex")
shannon_sex
pe_sex <- plot_box_whisker(malt_species.decontam_filtered.alpha, "Pileou_evenness", "Sex", "Sex", "Sex")
pe_sex

os_ts <- plot_box_whisker(malt_species.decontam_filtered.alpha, "Observed_species", "Tooth_site", "Tooth_site", "Tooth_site")
os_ts
shannon_ts <- plot_box_whisker(malt_species.decontam_filtered.alpha, "Shannon_index", "Tooth_site", "Tooth_site", "Tooth_site")
shannon_ts
pe_ts <- plot_box_whisker(malt_species.decontam_filtered.alpha, "Pileou_evenness", "Tooth_site", "Tooth_site", "Tooth_site")
pe_ts
...
ggsave("./06-publication/supplemental_figures/SXX6/panel_parts/Figure_SXX6_shannon_market_split.pdf", plot = shannon_market_split, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX6/panel_parts/Figure_SXX6_pe_market_split.pdf", plot = pe_market_split, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX6/panel_parts/Figure_SXX6_os_age.pdf", plot = os_age, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX6/panel_parts/Figure_SXX6_shannon_age.pdf", plot = shannon_age, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX6/panel_parts/Figure_SXX6_pe_age.pdf", plot = pe_age, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX6/panel_parts/Figure_SXX6_os_sex.pdf", plot = os_sex, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX6/panel_parts/Figure_SXX6_shannon_sex.pdf", plot = shannon_sex, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX6/panel_parts/Figure_SXX6_pe_sex.pdf", plot = pe_sex, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX6/panel_parts/Figure_SXX6_os_tooth_site.pdf", plot = os_ts, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX6/panel_parts/Figure_SXX6_shannon_tooth_site.pdf", plot = shannon_ts, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX6/panel_parts/Figure_SXX6_pe_tooth_site.pdf", plot = pe_ts, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)
...
og_env
shannon_env <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Shannon_index", "Env", "Env", "Environment")
shannon_env
pe_env <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Pileou_evenness", "Env", "Env", "Environment")
pe_env

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_os_env_gn.pdf", plot = og_env, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_shannon_env_gn.pdf", plot = shannon_env, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_pe_env_gn.pdf", plot = pe_env, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

og_ethnicity <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Observed_genera", "Ethnic_Group", "Ethnic_Group", "Ethnic group")
og_ethnicity
shannon_ethnicity <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Shannon_index", "Ethnic_Group", "Ethnic_Group", "Ethnic group")
shannon_ethnicity
pe_ethnicity <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Pileou_evenness", "Ethnic_Group", "Ethnic_Group", "Ethnic group")
pe_ethnicity

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_os_ethnic_group_gn.pdf", plot = og_ethnicity, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_shannon_ethnic_group_gn.pdf", plot = shannon_ethnicity, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_pe_ethnic_group_gn.pdf", plot = pe_ethnicity, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)
...
og_market
shannon_market <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Shannon_index", "Market_economy", "Market_economy", "Market economy")
shannon_market
pe_market <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Pileou_evenness", "Market_economy", "Market_economy", "Market economy")
pe_market

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_os_market_gn.pdf", plot = og_market, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_shannon_market_gn.pdf", plot = shannon_market, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_pe_market_gn.pdf", plot = pe_market, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

og_village <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Observed_genera", "Village", "Village", "Village")
og_village
shannon_village <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Shannon_index", "Village", "Village", "Village")
shannon_village
pe_village <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Pileou_evenness", "Village", "Village", "Village")
pe_village

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_og_village_gn.pdf", plot = og_village, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_shannon_village_gn.pdf", plot = shannon_village, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_pe_village_gn.pdf", plot = pe_village, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

og_market_split <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Observed_genera", "Market_economy_split", "Market_economy_split", "Market economy")
og_market_split
shannon_market_split <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Shannon_index", "Market_economy_split", "Market_economy_split", "Market economy")
shannon_market_split
pe_market_split <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Pileou_evenness", "Market_economy_split", "Market_economy_split", "Market economy")
pe_market_split

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_og_market_split_gn.pdf", plot = og_market_split, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_shannon_market_split_gn.pdf", plot = shannon_market_split, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_pe_market_split_gn.pdf", plot = pe_market_split, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

og_age <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Observed_genera", "Age_group", "Age_group", "Age_group economy")
og_age
shannon_age <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Shannon_index", "Age_group", "Age_group", "Age_group")
shannon_age
pe_age <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Pileou_evenness", "Age_group", "Age_group", "Age_group")
pe_age

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_og_age_gn.pdf", plot = og_age, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_shannon_age_gn.pdf", plot = shannon_age, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_pe_age_gn.pdf", plot = pe_age, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

og_sex <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Observed_genera", "Sex", "Sex", "Sex")
og_sex
shannon_sex <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Shannon_index", "Sex", "Sex", "Sex")
shannon_sex
pe_sex <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Pileou_evenness", "Sex", "Sex", "Sex")
pe_sex

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_og_sex_gn.pdf", plot = og_sex, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_shannon_sex_gn.pdf", plot = shannon_sex, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_pe_sex_gn.pdf", plot = pe_sex, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

og_ts <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Observed_genera", "Tooth_site", "Tooth_site", "Tooth_site")
og_ts
shannon_ts <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Shannon_index", "Tooth_site", "Tooth_site", "Tooth_site")
shannon_ts
pe_ts <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Pileou_evenness", "Tooth_site", "Tooth_site", "Tooth_site")
pe_ts

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_og_tooth_site_gn.pdf", plot = og_ts, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_shannon_tooth_site_gn.pdf", plot = shannon_ts, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX7/panel_parts/Figure_SXX7_pe_tooth_site_gn.pdf", plot = pe_ts, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)
...
fwrite(genus_kruskal_pvals, "./06-publication/supplemental_tables/alphadiv_kruskal_wallace_all_gn.tsv", sep = "\t", quote = F)
...
fwrite(IC_genus_p_es, "./06-publication/supplemental_tables/alphadiv_wilcox_all_gn.tsv", sep = "\t", quote = F)
...
ggsave("./06-publication/supplemental_figures/SXX32/panel_parts/Figure_SXX32_og_village_cmc_gn.pdf", plot = og_village, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX32/panel_parts/Figure_SXX32_shannon_village_cmc_gn.pdf", plot = shannon_village, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX32/panel_parts/Figure_SXX32_pe_village_cmc_gn.pdf", plot = pe_village, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

og_tooth <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Observed_genera", "Tooth_site", "Tooth_site", "Tooth site")
og_tooth
shannon_tooth <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Shannon_index", "Tooth_site", "Tooth_site", "Tooth site")
shannon_tooth
pe_tooth <- plot_box_whisker(malt_genus.decontam_filtered.alpha, "Pileou_evenness", "Tooth_site", "Tooth_site", "Tooth site")
pe_tooth

ggsave("./06-publication/supplemental_figures/SXX32/panel_parts/Figure_SXX32_og_tooth_site_gn.pdf", plot = og_tooth, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX32/panel_parts/Figure_SXX32_shannon_tooth_site_gn.pdf", plot = shannon_tooth, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX32/panel_parts/Figure_SXX32_pe_tooth_site_gn.pdf", plot = pe_tooth, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)
...
ggsave("./06-publication/supplemental_figures/SXX32/panel_parts/Figure_SXX32_og_sex_cmc_gn.pdf", plot = og_sex, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX32/panel_parts/Figure_SXX32_shannon_sex_cmc_gn.pdf", plot = shannon_sex, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX32/panel_parts/Figure_SXX32_pe_sex_cmc_gn.pdf", plot = pe_sex, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)
...
fwrite(genus_kruskal_pvals, "./06-publication/supplemental_tables/alphadiv_kruskal_wallace_cmc_gn.tsv", sep = "\t", quote = F)
...
fwrite(IC_genus_cmc_p_es, "./06-publication/supplemental_tables/alphadiv_wilcox_cmc_gn.tsv", sep = "\t", quote = F)
...
fwrite(wilcox_genus_sex_p_es, "./06-publication/supplemental_tables/alphadiv_wilcox_cmc_gn_village_sex.tsv", sep = "\t", quote = F)

# make a plot of village split by sex
og_village_sex <- malt_genus.decontam_filtered.alpha_meta %>%
  mutate(Village = fct_relevel(Village, "202","205","204","203","206")) %>%
...
ggsave("./06-publication/supplemental_figures/SXX32/panel_parts/Figure_SXX32_og_village_sex_gn.pdf", plot = og_village_sex, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)


# make a plot of village split by sex
shannon_village_sex <- malt_genus.decontam_filtered.alpha_meta %>%
  mutate(Village = fct_relevel(Village, "202","205","204","203","206")) %>%
  ggplot(., aes(x = Village, y = Shannon_index, fill = Sex)) +
         geom_boxplot(outlier.size = 0) +
         geom_point(position = position_jitterdodge(jitter.width = 0), alpha = 0.5) +
...
ggsave("./06-publication/supplemental_figures/SXX32/panel_parts/Figure_SXX32_shannon_village_sex_gn.pdf", plot = shannon_village_sex, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

# make a plot of village split by sex
pe_village_sex <- malt_genus.decontam_filtered.alpha_meta %>%
  mutate(Village = fct_relevel(Village, "202","205","204","203","206")) %>%
  ggplot(., aes(x = Village, y = Pileou_evenness, fill = Sex)) +
         geom_boxplot(outlier.size = 0) +
         geom_point(position = position_jitterdodge(jitter.width = 0), alpha = 0.5) +
...
ggsave("./06-publication/supplemental_figures/SXX32/panel_parts/Figure_SXX32_pe_village_sex_gn.pdf", plot = pe_village_sex, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)
...
ggsave("./06-publication/supplemental_figures/SXX31/Figure_SXX31_top50_gn_heatmap_clustered.pdf", plot = heatmap_base, device = "pdf",
       scale = 1, width = 8, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX31/Figure_SXX31_top50_gn_heatmap_clustered.png", plot = heatmap_base, device = "png",
       scale = 1, width = 8, height = 5, units = c("in"), dpi = 300)
...
ggsave("./06-publication/supplemental_figures/SXX30/Figure_SXX30_top50_gn_heatmap.pdf", plot = heatmap_base, device = "pdf",
       scale = 1, width = 8, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX30/Figure_SXX30_top50_gn_heatmap.png", plot = heatmap_base, device = "png",
       scale = 1, width = 8, height = 5, units = c("in"), dpi = 300)
