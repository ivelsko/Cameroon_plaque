...
metadata <- metadata %>%
  ...
  as_tibble() %>%
  mutate(Description = fct_relevel(Description, "CMC", "Yanomami", "HMP_supPlaque", "HMP_subPlaque",
                                   "HMP10M_supPlaque", "HMP10M_subPlaque","JAE","JAE10M", "VLC",
                                   "ExtractionGauze","ExtractionBlank","LibraryBlank"),
         Ethnic_Group = fct_relevel(Ethnic_Group, "Baka","Nzime","Yanomami","Industrial plaque","Industrial calculus",
                                     "ExtractionGauze","ExtractionBlank","LibraryBlank"),
         ...
         Env = fct_relevel(Env, "CMC","HMP","HMP10M","JAE","JAE10M",
                                     "ExtractionGauze","ExtractionBlank","LibraryBlank"),
         ...
         Market_integration = fct_relevel(Market_integration, "Logging road","Forest camp","Farming","Yanomami",
                                      "Industrial","ExtractionGauze","ExtractionBlank","LibraryBlank"),
         Market_integration_split = fct_relevel(Market_integration_split, "Logging road","Forest camp","Farming","Yanomami",
         ...
         Village = fct_relevel(Village, "202","205","204","203","206","Yanomami","Industrial plaque","Industrial calculus",
                               "ExtractionGauze","ExtractionBlank","LibraryBlank"))
...
Ethnic_Group_colors <- c(Baka = "#FF3200", Nzime = "#065FA3", Yanomami = "#C70E7B", `Industrial plaque` = "#969696", 
                         `Industrial calculus` = "#feb24c", ExtractionGauze = "#252525", ExtractionBlank = "#737373", LibraryBlank = "#bdbdbd")
Ethnic_Group_shapes <- c(Baka = 19, Nzime = 17,  Yanomami = 14, `Industrial plaque` = 7, `Industrial calculus` = 7,
                         ExtractionGauze = 8, ExtractionBlank = 4, LibraryBlank = 3)
Ethnic_Group_size <- c(Baka = 4, Nzime = 4,  Yanomami = 4, `Industrial plaque` = 4, `Industrial calculus` = 4, 
                         ExtractionGauze = 4, ExtractionBlank = 4, LibraryBlank = 4)

Env_colors <- c(CMC = "#FF3200", `Industrial plaque` = "#969696", HMP10M = "#172869", JAE10M = "#ffeda0", `Industrial calculus` = "#feb24c",
                ExtractionGauze = "#252525", ExtractionBlank = "#737373", LibraryBlank = "#bdbdbd")
Env_shapes <- c(CMC = 19, `Industrial plaque` = 7, `Industrial calculus` = 7, ExtractionGauze = 8, ExtractionBlank = 4, LibraryBlank = 3)
Env_size <- c(CMC = 4, `Industrial plaque` = 4, `Industrial calculus` = 4, ExtractionGauze = 4, ExtractionBlank = 4, LibraryBlank = 4)
...
Description_colors <- c(CMC = "#FF3200", Yanomami = "#C70E7B", HMP_supPlaque = "#065FA3", HMP_subPlaque = "#065FA3", # HMP_supPlaque = "#", HMP_subPlaque = "#172869", 
                        HMP10M_supPlaque = "#172869", HMP10M_subPlaque = "#172869", JAE10M = "#ffeda0", JAE = "#feb24c", VLC = "#feb24c",
                        ExtractionGauze = "#252525", ExtractionBlank = "#737373", LibraryBlank = "#bdbdbd")
Description_shapes <- c(CMC = 19, Yanomami = 14, HMP_supPlaque = 10, HMP_subPlaque = 13, HMP10M_supPlaque = 10, 
                        HMP10M_subPlaque = 13, JAE = 7, JAE10M = 9, VLC = 7, ExtractionGauze = 8, ExtractionBlank = 4, LibraryBlank = 3)
Description_size <- c(CMC = 4, Yanomami = 4, HMP_supPlaque = 4, HMP_subPlaque = 4, HMP10M_supPlaque = 4, 
                        HMP10M_subPlaque = 4, JAE = 4, JAE10M = 4, VLC = 4, ExtractionGauze = 4, ExtractionBlank = 4, LibraryBlank = 4)
...
Market_integration_colors <- c(`Logging road` = "#FF3200", `Forest camp` = "#82CDAA", Farming = "#065FA3", Yanomami = "#C70E7B", Industrial = "#969696",
                           ExtractionGauze = "#252525", ExtractionBlank = "#737373", LibraryBlank = "#bdbdbd")
Market_integration_shapes <- c(`Logging road` = 19, `Forest camp` = 18, Farming = 17, Yanomami = 14, Industrial = 7,
                           ExtractionGauze = 8, ExtractionBlank = 4, LibraryBlank = 3)
Market_integration_size <- c(`Logging road` = 4, `Forest camp` = 6, Farming = 4, Yanomami = 4, Industrial = 4,
                           ExtractionGauze = 4, ExtractionBlank = 4, LibraryBlank = 4)

Market_integration_split_colors <- c(`Logging road` = "#FF3200", `Forest camp` = "#82CDAA", Farming = "#065FA3", Yanomami = "#C70E7B", `Industrial plaque` = "#969696",
                           `Industrial calculus` = "#feb24c", ExtractionGauze = "#252525", ExtractionBlank = "#737373", LibraryBlank = "#bdbdbd")
Market_integration_split_shapes <- c(`Logging road` = 19, `Forest camp` = 18, Farming = 17, Yanomami = 14, `Industrial plaque` = 7,
                           `Industrial calculus` = 7, ExtractionGauze = 8, ExtractionBlank = 4, LibraryBlank = 3)
Market_integration_split_size <- c(`Logging road` = 4, `Forest camp` = 6, Farming = 4, Yanomami = 4, `Industrial plaque` = 4,
...
Village_colors <- c(`202` = "#FF3200", `205` = "#EF8158", `204` = "#E9BD8E", `203` = "#CBDDA7", `206` = "#38BCAD",
                    Yanomami = "#C70E7B", `Industrial plaque` = "#065FA3", HMP10M = "#172869", JAE10M = "#ffeda0", `Industrial calculus` = "#feb24c",
                     ExtractionGauze = "#252525", ExtractionBlank = "#737373", LibraryBlank = "#bdbdbd")
Village_shapes <- c(`202` = 15, `203` = 16, `205` = 17,`204` = 18, `206` = 25, Yanomami = 14, `Industrial plaque` = 7, HMP10M = 9, `Industrial calculus` = 7, JAE10M = 9,
                    ExtractionGauze = 8, ExtractionBlank = 4, LibraryBlank = 3)
Village_size <- c(`202` = 4.5, `203` = 4, `205` = 4,`204` = 6, `206` = 4, Yanomami = 4, `Industrial plaque` = 4, HMP10M = 4, `Industrial calculus` = 4, JAE10M = 4,
                    ExtractionGauze = 4, ExtractionBlank = 4, LibraryBlank = 4)
...
save(metadata, 
     ...
     Market_integration_colors, Market_integration_shapes, Market_integration_size,
     Market_integration_split_colors, Market_integration_split_shapes, Market_integration_split_size,
     ...
     Decayed_colors, Decayed_shapes, Decayed_size,
     Missing_colors, Missing_shapes, Missing_size,
     Root_visible_colors, Root_visible_shapes, Root_visible_size,
     Altered_colors, Altered_shapes, Altered_size,
