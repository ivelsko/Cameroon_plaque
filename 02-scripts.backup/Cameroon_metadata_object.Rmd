...
ExtractionBatch_colors <- c(`Ex01_VE_2019-01-23` = "#FF3200", `Ex04_VE_2019-02-18` = "#172869", `Ex05_VE_2019-02-18` = "#C70E7B", 
                            `Ex06_VE_2019-02-21` = "#969696", `Ex07_VE_2019-02-21` = "#d9d9d9", 
                         `Ex08_VE_2019-02-25` = "#ffeda0", `Ex09_VE_2019-03-13` = "#feb24c")
ExtractionBatch_shapes <- c(`Ex01_VE_2019-01-23` = 19, `Ex04_VE_2019-02-18` = 17,  `Ex05_VE_2019-02-18` = 14, `Ex06_VE_2019-02-21` = 7, 
                            `Ex07_VE_2019-02-21` = 9, `Ex08_VE_2019-02-25` = 7, `Ex09_VE_2019-03-13` = 9)
ExtractionBatch_size <- c(`Ex01_VE_2019-01-23` = 4, `Ex04_VE_2019-02-18` = 4,  `Ex05_VE_2019-02-18` = 4, `Ex06_VE_2019-02-21` = 4, 
                          `Ex07_VE_2019-02-21` = 4, `Ex08_VE_2019-02-25` = 4, `Ex09_VE_2019-03-13` = 4)
...
Kraken_db_colors <- c(RefSeqOnly = "#172869", RefSeqPasolliMAGs = "#FF3200")
...
LibraryBatch_colors <- c(`Li03_VE_2019-04-17` = "#FF3200", `Li04_VE_2019-04-17` = "#172869", `Li05_VE_2019-04-17` = "#C70E7B", 
                            `Li06_VE_2019-05-02` = "#969696", `Li07_VE_2019-05-06` = "#d9d9d9", 
                         `Li08_VE_2019-05-06` = "#ffeda0", `Li09_VE_2019-05-06` = "#feb24c")
LibraryBatch_shapes <- c(`Li03_VE_2019-04-17` = 19, `Li04_VE_2019-04-17` = 17,  `Li05_VE_2019-04-17` = 14, `Li06_VE_2019-05-02` = 7, 
                            `Li07_VE_2019-05-06` = 9, `Li08_VE_2019-05-06` = 7, `Li09_VE_2019-05-06` = 9)
LibraryBatch_size <- c(`Li03_VE_2019-04-17` = 4, `Li04_VE_2019-04-17` = 4,  `Li05_VE_2019-04-17` = 4, `Li06_VE_2019-05-02` = 4, 
                          `Li07_VE_2019-05-06` = 4, `Li08_VE_2019-05-06` = 4, `Li09_VE_2019-05-06` = 4)
...
save(metadata, 
     ...
     Market_economy_colors, Market_economy_size, Market_economy_size,
