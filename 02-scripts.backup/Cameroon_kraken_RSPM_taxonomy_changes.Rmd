...
# 
# 
# rso_obj_noV <- filter_taxa(rso_obj, "tax_abund", !str_detect(tax_data$Taxonomy, "Virus"))
# rso_obj_noV <- filter_taxa(rso_obj, taxon_names == "Virus"))
...
set.seed(1)
rsomp_obj_noV_tree_NI_rso <- heat_tree(rsomp_obj_noV, 
          node_label = rsomp_obj_noV$taxon_names(),
          node_size = rsomp_obj_noV$n_obs(),
...
set.seed(1)
rsomp_obj_noV_tree_NI_rsmp <- heat_tree(rsomp_obj_noV, 
          node_label = rsomp_obj_noV$taxon_names(),
          node_size = rsomp_obj_noV$n_obs(),
