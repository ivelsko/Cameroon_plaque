...
# sets the OTU names as the column headers of the input matrix
...
# this puts back column names that got distorted by the step above
...
```{r}
malt_species.decontam_filtered_noblanks_clr.ancom <- ANCOM.main(OTUdat = malt_species.decontam_filtered_noblanks_clr_test, Vardat = metadata, adjusted = F, repeated = F,
                                                                main.var = "Tooth_site", adj.formula = NULL, sig = 0.05, prev.cut = 0.90)
```
