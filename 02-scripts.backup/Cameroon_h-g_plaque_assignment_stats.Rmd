...
Database_colors <- c("#172869", "#FF3200")
```
...
test_plot <- plot_box_whisker(maltnt_assignments, "Percent", "Env", "Env", "Percent of reads assigned by MALT with nt2017")
test_plot
```
...
db_plot_test <- plot_box_whisker(malt_stats_new, "Queries", "Env", "Database", "Percent of reads assigned by MALT with nt2017 and RefSeqCustom")
db_plot_test
