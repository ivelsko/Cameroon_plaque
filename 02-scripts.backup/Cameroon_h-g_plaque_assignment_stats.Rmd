...
maltnt_assignments <- fread("/Users/oval_portrait/projects1/microbiome_calculus/cameroon_hunter_gatherer_calculus/04-analysis/malt/nt/aligned_stats.tsv")
maltRSC_assignments <- fread("/Users/oval_portrait/projects1/microbiome_calculus/cameroon_hunter_gatherer_calculus/04-analysis/malt/RefSeqCustom/aligned_stats.tsv")
malt_CMC_HMP_RSC_assignments <- fread("/Users/oval_portrait/projects1/microbiome_calculus/cameroon_hunter_gatherer_calculus/04-analysis/malt/RefSeqCustom/aligned_stats.tsv")
...
malt_CMC_HMP_RSC_assignments$SampleID <- gsub(".SG1.1_S0_L001_R1_001.fastq.combined.fq.prefixed.extractunmapped.bam.rma6","", malt_CMC_HMP_RSC_assignments$SampleID)
malt_CMC_HMP_RSC_assignments$SampleID <- gsub("_S0_L001_R1_000.fastq.combined.fq.prefixed.extractunmapped.bam.rma6","", malt_CMC_HMP_RSC_assignments$SampleID)
malt_CMC_HMP_RSC_assignments$SampleID <- gsub("_S0_L001_R1_000.10M.fastq.combined.fq.prefixed.extractunmapped.bam.rma6","_10M", malt_CMC_HMP_RSC_assignments$SampleID)
...
```{r graphs_RSC}
# merge with metadata
maltRSC_stats <- malt_CMC_HMP_RSC_assignments %>%
  inner_join(., metadata)
...
ggsave("/Users/oval_portrait/Dropbox (Personal)/MPI-SHH/CMC/malt_assignments_plots_pct_group.pdf", plot = malt_assignments_plots_pct_group, device = "pdf",
...
ggsave("/Users/oval_portrait/Dropbox (Personal)/MPI-SHH/CMC/malt_assignments_plots_pct_village.pdf", plot = malt_assignments_plots_pct_village, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"),
       dpi = 300)
