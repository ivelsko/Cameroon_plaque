...
maltnt_assignments <- fread("00-documentation.backup/aligned_stats.tsv")
maltRSC_assignments <- fread("00-documentation.backup/aligned_stats.tsv")
malt_CMC_HMP_RSC_assignments <- fread("00-documentation.backup/aligned_stats.tsv")
