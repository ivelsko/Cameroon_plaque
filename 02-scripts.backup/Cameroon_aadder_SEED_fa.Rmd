...
ggsave("./06-publication/supplemental_figures/SXX22/SXX22_seed_lda.pdf", plot = allplots_seed,
       device = "pdf", scale = 1, width = 8, height = 10, units = c("in"), dpi = 300)
ggsave("./06-publication/supplemental_figures/SXX22/SXX22_seed_lda.png", plot = allplots_seed,
...
ggsave("./06-publication/supplemental_figures/SXX23/SXX23_seed_cmc_lda.pdf", plot = cmcplots_seed_fada,
       device = "pdf", scale = 1, width = 8, height = 10, units = c("in"), dpi = 300)
ggsave("./06-publication/supplemental_figures/SXX23/SXX23_seed_cmc_lda.png", plot = cmcplots_seed_fada,
       device = "png", scale = 1, width = 8, height = 10, units = c("in"), dpi = 300)
