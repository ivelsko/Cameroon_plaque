...
seed_full <- fread("./05-results.backup/aadder_SEED_counts_corrected.txt")
...
# write.table(malt_species.decontam, file = "05-results.backup/aadder_seed.decontam.tsv", sep="\t", quote=F, row.names = F)
# write.table(malt_species, "05-results.backup/aadder_seed.tsv", sep="\t", quote=F, row.names = F)
# write.table(contaminants_species, "05-results.backup/aadder_seed_contaminants_species.tsv", sep="\t", quote=F, row.names = F)
