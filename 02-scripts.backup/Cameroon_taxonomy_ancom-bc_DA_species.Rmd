...
fwrite(ancom_bc_cmc_Fa_FC, "./05-results.backup/ancomBC_species_noblanks_FA_FC.tsv", sep = "\t", quote = F)
...
# fwrite(ancom_bc_cmc_Fa_LR, "./05-results.backup/ancomBC_species_noblanks_FA_LR.tsv", sep = "\t", quote = F)
