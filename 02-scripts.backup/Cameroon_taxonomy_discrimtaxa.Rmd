...
```{r da_species_decontam_noblanks_noyanomami_eg, eval = F}
...
```{r da_species_decontam_noblanks_noyanomami_age, eval = F}
# select only the species that make up the 1st 2 residuals, based on the scree plot above
fa_species_noblanks_noyanomami <- malt_species.decontam_filtered_noblanks_noyanomami.fa.df %>% 
  filter(Residual %in% c("MR1","MR2")) %>%
  pull(Species)
...
```{r da_species_decontam_noblanks_noyanomami_me, eval = F}
# select only the species that make up the 1st 2 residuals, based on the scree plot above
fa_species_noblanks_noyanomami <- malt_species.decontam_filtered_noblanks_noyanomami.fa.df %>% 
  filter(Residual %in% c("MR1","MR2")) %>%
  pull(Species)
...
```{r da_species_decontam_noblanks_noyanomami_sex, eval = F}
# select only the species that make up the 1st 2 residuals, based on the scree plot above
fa_species_noblanks_noyanomami <- malt_species.decontam_filtered_noblanks_noyanomami.fa.df %>% 
  filter(Residual %in% c("MR1","MR2")) %>%
  pull(Species)
...
```{r da_species_decontam_noblanks_noyanomami_ts, eval = F}
# select only the species that make up the 1st 2 residuals, based on the scree plot above
fa_species_noblanks_noyanomami <- malt_species.decontam_filtered_noblanks_noyanomami.fa.df %>% 
  filter(Residual %in% c("MR1","MR2")) %>%
  pull(Species)
...
```{r da_species_decontam_noblanks_noyanomami_vi, eval = F}
# select only the species that make up the 1st 2 residuals, based on the scree plot above
fa_species_noblanks_noyanomami <- malt_species.decontam_filtered_noblanks_noyanomami.fa.df %>% 
  filter(Residual %in% c("MR1","MR2")) %>%
  pull(Species)
