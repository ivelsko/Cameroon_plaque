...
malt_species.decontam_filtered_noblanks.fa <- fa(malt_species.decontam_filtered_noblanks_clr, nfactors = 6, rotate = "varimax", fm = "ols") # rotate = "Varimax" "oblimin" # fm = "ols" "minres"
...
malt_species.decontam_filtered_noblanks_noyanomami.fa <- fa(malt_species.decontam_filtered_noblanks_noyanomami_clr, nfactors = 7, rotate = "oblimin", fm = "ols") # rotate = "Varimax" "oblimin" # fm = "ols" "minres"
...
malt_species.decontam_filtered_cmc.fa <- fa(malt_species.decontam_filtered_cmc_clr, nfactors = 6, rotate = "oblimin", fm = "ols") # rotate = "oblimin" "Varimax" # fm = "ols" "minres"
...
malt_species.decontam_filtered_cmc.fa.df <- malt_species.decontam_filtered_cmc.fa.df %>%
  ...
  mutate(MR11 = as.character(MR11),
         ...
         MR21 = as.character(MR21)) %>%
  mutate(MR11 = replace(MR11, MR11 != "0", "MR1"),
         MR31 = replace(MR21, MR31 != "0", "MR3"),
         MR21 = replace(MR31, MR21 != "0", "MR2")) %>%
  select(Species,everything(.)) %>%
...
fa_species_cmc <- malt_species.decontam_filtered_cmc.fa.df %>% 
  filter(Residual %in% c("MR1","MR3","MR2")) %>%
  pull(Species)
