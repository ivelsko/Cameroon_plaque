...
rownames(humann2_KOs.decontam_noblanks_33) <- humann2_KOs.decontam_noblanks_33$SampleID
humann2_KOs.decontam_noblanks_33 <- as.matrix(humann2_KOs.decontam_noblanks_33 %>%
  select(-SampleID)) + 1
...
# decontam and abundance >0.005% filtered plots
plot_pca(humann2_KO_noblanks.pca, "PC1", "PC2", "Ethnic_Group", "Ethnic_Group", "Ethnic_Group")
...
rownames(humann2_KOs.decontam_mr1) <- humann2_KOs.decontam_mr1$SampleID
humann2_KOs.decontam_mr1 <- as.matrix(humann2_KOs.decontam_mr1 %>%
  select(-SampleID)) + 1
...
rownames(humann2_KOs.decontam_cmc_33) <- humann2_KOs.decontam_cmc_33$SampleID
humann2_KOs.decontam_cmc_33 <- as.matrix(humann2_KOs.decontam_cmc_33 %>%
  select(-SampleID)) + 1
...
rownames(humann2_KOs.decontam_cmc_mr1) <- humann2_KOs.decontam_cmc_mr1$SampleID
humann2_KOs.decontam_cmc_mr1 <- as.matrix(humann2_KOs.decontam_cmc_mr1 %>%
  select(-SampleID)) + 1
...
rownames(humann2_KO_carbs) <- humann2_KO_carbs$SampleID
humann2_KO_carbs <- as.matrix(humann2_KO_carbs %>%
  select(-SampleID)) + 1
...
rownames(humann2_KO_cmc_carbs) <- humann2_KO_cmc_carbs$SampleID
humann2_KO_cmc_carbs <- as.matrix(humann2_KO_cmc_carbs %>%
  select(-SampleID)) + 1
