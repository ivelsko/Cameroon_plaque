...
SAMPLES=( $(find /projects1/microbiome_calculus/cameroon_hunter_gatherer_calculus/03-preprocessing/human_filering/output_temp/ -name '*.fastq.combined.fq.prefixed.extractunmapped.bam' -type f) )
