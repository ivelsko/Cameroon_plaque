...
batch_table_os <- malt_species.decontam %>%
               ...
               spread(Species, Counts) %>%
               filter(!str_detect(SampleID, "SRR|JAE|EXB|LIB")) %>%
               ...
               inner_join(metadata %>%
                           select(SampleID, Env, Description, Ethnic_Group, Age_group,
                                  Sex, Market_integration, Village, Tooth_site, ExtractionBatch, LibraryBatch, Type), by = "SampleID") %>%
               filter(!is.na(LibraryBatch)) %>%
               filter(!str_detect(SampleID, "VLC"))

# plot extraction batch
exb_unfiltered_os_plot <- batch_table_os %>%
  filter(!is.na(ExtractionBatch)) %>%
    ggplot(., aes(x = ExtractionBatch, y = Observed_species, fill = ExtractionBatch)) +
       ...
       ggtitle("Extraction batches")
exb_unfiltered_os_plot

ggsave("./06-publication/supplemental_figures/SXX2/SXX2_exb_unfiltered_os_plot.pdf", plot = exb_unfiltered_os_plot, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX2/SXX2_exb_unfiltered_os_plot.png", plot = exb_unfiltered_os_plot, device = "png",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

# plot library batch
lib_unfiltered_os_plot <- ggplot(batch_table_os, aes(x = LibraryBatch, y = Observed_species, fill = LibraryBatch)) +
       geom_boxplot() +
       geom_jitter(alpha = 0.5) +
       theme_minimal() +
       theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
       ylab("Number of species") +
       ggtitle("Library batches")
lib_unfiltered_os_plot

ggsave("./06-publication/supplemental_figures/SXX2/SXX2_lib_unfiltered_os_plot.pdf", plot = lib_unfiltered_os_plot, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX2/SXX2_lib_unfiltered_os_plot.png", plot = lib_unfiltered_os_plot, device = "png",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)
...
# plot extraction batch
exb_unfiltered_og_plot <- batch_table_og %>%
  filter(!is.na(ExtractionBatch)) %>%
    ggplot(., aes(x = ExtractionBatch, y = Observed_species, fill = ExtractionBatch)) +
       geom_boxplot() +
       geom_jitter(alpha = 0.5) +
       ...
       ggtitle("Extraction batches")
exb_unfiltered_og_plot

ggsave("./06-publication/supplemental_figures/SXX2/SXX2_exb_unfiltered_og_plot.pdf", plot = exb_unfiltered_og_plot, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX2/SXX2_exb_unfiltered_og_plot.png", plot = exb_unfiltered_og_plot, device = "png",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

# plot library batch
lib_unfiltered_og_plot <- ggplot(batch_table_og, aes(x = LibraryBatch, y = Observed_species, fill = LibraryBatch)) +
       geom_boxplot() +
       geom_jitter(alpha = 0.5) +
       theme_minimal() +
       theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
       ylab("Number of genera") +
       ggtitle("Library batches")
lib_unfiltered_og_plot

ggsave("./06-publication/supplemental_figures/SXX2/SXX2_lib_unfiltered_og_plot.pdf", plot = lib_unfiltered_og_plot, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX2/SXX2_lib_unfiltered_og_plot.png", plot = lib_unfiltered_og_plot, device = "png",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)
...
# plot extraction batch
exb_unfiltered_shannon_sp_plot <- malt_species.decontam.shannon %>%
  filter(!is.na(ExtractionBatch)) %>%
    ggplot(., aes(x = ExtractionBatch, y = `Shannon index`, fill = ExtractionBatch)) +
       ...
       ylab("Shannon index") +
       ggtitle("Extraction batches")
exb_unfiltered_shannon_sp_plot

ggsave("./06-publication/supplemental_figures/SXX2/SXX2_exb_unfiltered_shannon_sp_plot.pdf", plot = exb_unfiltered_shannon_sp_plot, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX2/SXX2_exb_unfiltered_shannon_sp_plot.png", plot = exb_unfiltered_shannon_sp_plot, device = "png",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

# plot library batch
lib_unfiltered_shannon_sp_plot <- ggplot(malt_species.decontam.shannon, aes(x = LibraryBatch, y = `Shannon index`, fill = LibraryBatch)) +
       geom_boxplot() +
       geom_jitter(alpha = 0.5) +
       theme_minimal() +
       theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
       ylab("Shannon index") +
       ggtitle("Library batches")
lib_unfiltered_shannon_sp_plot

ggsave("./06-publication/supplemental_figures/SXX2/SXX2_lib_unfiltered_shannon_sp_plot.pdf", plot = lib_unfiltered_shannon_sp_plot, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX2/SXX2_lib_unfiltered_shannon_sp_plot.png", plot = lib_unfiltered_shannon_sp_plot, device = "png",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)
...
# plot extraction batch
exb_unfiltered_shannon_gn_plot <- malt_genus.decontam.shannon %>%
  filter(!is.na(ExtractionBatch)) %>%
    ggplot(., aes(x = ExtractionBatch, y = `Shannon index`, fill = ExtractionBatch)) +
       geom_boxplot() +
       geom_jitter(alpha = 0.5) +
...
exb_unfiltered_shannon_gn_plot

ggsave("./06-publication/supplemental_figures/SXX2/SXX2_exb_unfiltered_shannon_gn_plot.pdf", plot = exb_unfiltered_shannon_gn_plot, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX2/SXX2_exb_unfiltered_shannon_gn_plot.png", plot = exb_unfiltered_shannon_gn_plot, device = "png",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

# plot library batch
lib_unfiltered_shannon_gn_plot <- ggplot(malt_genus.decontam.shannon, aes(x = LibraryBatch, y = `Shannon index`, fill = LibraryBatch)) +
       geom_boxplot() +
       geom_jitter(alpha = 0.5) +
       theme_minimal() +
       theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
       ylab("Shannon index") +
       ggtitle("Shannon index - genus")
lib_unfiltered_shannon_gn_plot

ggsave("./06-publication/supplemental_figures/SXX2/SXX2_lib_unfiltered_shannon_gn_plot.pdf", plot = lib_unfiltered_shannon_gn_plot, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX2/SXX2_lib_unfiltered_shannon_gn_plot.png", plot = lib_unfiltered_shannon_gn_plot, device = "png",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)
