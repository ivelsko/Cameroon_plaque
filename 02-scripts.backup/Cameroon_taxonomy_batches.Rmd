...
# perform a kruskal-wallace test to determine if the extraction batches are differentially abundant
...
# perform a kruskal-wallace test to determine if the library batches are differentially abundant
kw_os <- batch_table_os %>%
