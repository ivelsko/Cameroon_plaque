...
rownames(seed_full_L4_33) <- seed_full_L4_33$SampleID
seed_full_L4_33 <- as.matrix(seed_full_L4_33 %>% 
  select(-SampleID)) + 1 # add +1 to all values to be able to do a CLR transformation before running PCA
...
rownames(seed_full_L4_mr1) <- seed_full_L4_mr1$SampleID
seed_full_L4_mr1 <- as.matrix(seed_full_L4_mr1 %>% 
  select(-SampleID)) + 1 # add +1 to all values to be able to do a CLR transformation before running PCA
...
rownames(seed_L4.decontam_noblanks_33) <- seed_L4.decontam_noblanks_33$SampleID
seed_L4.decontam_noblanks_33 <- seed_L4.decontam_noblanks_33 %>% select(-SampleID)
seed_L4.decontam_noblanks_33 = seed_L4.decontam_noblanks_33+1
# check the number of components to retain by tuning the PCA
...
rownames(seed_L4.decontam_noblanks_mr1) <- seed_L4.decontam_noblanks_mr1$SampleID
seed_L4.decontam_noblanks_mr1 <- as.matrix(seed_L4.decontam_noblanks_mr1 %>% 
  select(-SampleID)) + 1 # add +1 to all values to be able to do a CLR transformation before running PCA
...
seed_L4.decontam_noblanks_33.euc.vecmet <- inner_join(seed_L4.decontam_noblanks_33.euc.pcoavectors, metadata, by = "SampleID")

seed_L4.decontam_noblanks_33.euc.vecmet %>%
...
adonis2(seed_L4.decontam_noblanks_33.euc ~ ExtractionBatch + Village + Sex + Industry + Tooth_site + Ethnic_Group + Age_group +  LibraryBatch + Market_economy, seed_L4.decontam_noblanks_33.euc.vecmet, permutations = 999, by = "margin")

# controlled for tooth site
adonis2(seed_L4.decontam_noblanks_33.euc ~ ExtractionBatch + Village + Sex + Industry + Ethnic_Group + Age_group +  LibraryBatch + Market_economy, seed_L4.decontam_noblanks_33.euc.vecmet, permutations = 999, by = "margin", strata = metadata_noblanks_33$Tooth_site)
...
rownames(seed_L4.decontam_cmc_33) <- seed_L4.decontam_cmc_33$SampleID
seed_L4.decontam_cmc_33 <- as.matrix(seed_L4.decontam_cmc_33 %>% 
  select(-SampleID)) + 1 # add +1 to all values to be able to do a CLR transformation before running PCA
...
seed_L4.decontam_cmc_33.euc.vecmet <- inner_join(seed_L4.decontam_cmc_33.euc.pcoavectors, metadata, by = "SampleID")
...
# test for difference between different metadata categories 
adonis2(seed_L4.decontam_cmc_33.euc ~ ExtractionBatch + Village + Sex + Tooth_site + Ethnic_Group + Age_group +  LibraryBatch + Market_economy, seed_L4.decontam_cmc_33.euc.vecmet, permutations = 999, by = "margin")

# controlled for tooth site
adonis2(seed_L4.decontam_cmc_33.euc ~ ExtractionBatch + Village + Sex + Ethnic_Group + Age_group +  LibraryBatch + Market_economy, seed_L4.decontam_cmc_33.euc.vecmet, permutations = 999, by = "margin", strata = metadata_cmc_33$Tooth_site)
...
seed_L4.decontam_noblanks_mr1.euc.vecmet <- inner_join(seed_L4.decontam_noblanks_mr1.euc.pcoavectors, metadata, by = "SampleID")

seed_L4.decontam_noblanks_mr1.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Tooth_site, shape = Tooth_site)) +
  geom_point(size = 4) +
  scale_colour_manual(values = Tooth_site_colors) +
  scale_shape_manual(values = Tooth_site_shapes) +
...
# test for difference between different metadata categories 
adonis2(seed_L4.decontam_noblanks_mr1.euc ~ ExtractionBatch + Village + Sex + Industry + Tooth_site + Ethnic_Group + Age_group +  LibraryBatch + Market_economy, seed_L4.decontam_noblanks_mr1.euc.vecmet, permutations = 999, by = "margin")

# controlled for tooth site
adonis2(seed_L4.decontam_noblanks_mr1.euc ~ ExtractionBatch + Village + Sex + Industry + Ethnic_Group + Age_group +  LibraryBatch + Market_economy, seed_L4.decontam_noblanks_mr1.euc.vecmet, permutations = 999, by = "margin", strata = metadata_cmc_33$Tooth_site)
...
rownames(seed_L4.decontam_cmc_mr1) <- seed_L4.decontam_cmc_mr1$SampleID
seed_L4.decontam_cmc_mr1 <- as.matrix(seed_L4.decontam_cmc_mr1 %>% 
  select(-SampleID)) + 1 # add +1 to all values to be able to do a CLR transformation before running PCA
...
seed_L4.decontam_cmc_mr1.euc.vecmet <- inner_join(seed_L4.decontam_cmc_mr1.euc.pcoavectors, metadata, by = "SampleID")

seed_L4.decontam_cmc_mr1.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Tooth_site, shape = Tooth_site)) +
  geom_point(size = 4) +
  scale_colour_manual(values = Tooth_site_colors) +
  scale_shape_manual(values = Tooth_site_shapes) +
...
# test for difference between different metadata categories 
adonis(seed_L4.decontam_cmc_mr1.euc ~ Tooth_site + Ethnic_Group + Age_group + Sex + Village + Market_economy, seed_L4.decontam_cmc_mr1.euc.vecmet, perm=999)

# test for difference between different metadata categories 
adonis2(seed_L4.decontam_cmc_mr1.euc ~ ExtractionBatch + Village + Sex + Tooth_site + Ethnic_Group + Age_group +  LibraryBatch + Market_economy, seed_L4.decontam_cmc_mr1.euc.vecmet, permutations = 999, by = "margin")

# controlled for tooth site
adonis2(seed_L4.decontam_cmc_mr1.euc ~ ExtractionBatch + Village + Sex + Ethnic_Group + Age_group +  LibraryBatch + Market_economy, seed_L4.decontam_cmc_mr1.euc.vecmet, permutations = 999, by = "margin", strata = metadata_noblanks$Tooth_site)
...
rownames(seed_L4_carbohydrates) <- seed_L4_carbohydrates$SampleID
seed_L4_carbohydrates <- as.matrix(seed_L4_carbohydrates %>% 
  select(-SampleID)) + 1 # add +1 to all values to be able to do a CLR transformation before running PCA
...
seed_L4_carbohydrates_noblanks.euc.vecmet <- inner_join(seed_L4_carbohydrates_noblanks.euc.pcoavectors, metadata, by = "SampleID")
...
metadata_noblanks <- metadata %>%
  ...
  select(SampleID, ExtractionBatch, LibraryBatch, Village, Age_group, Market_economy, Ethnic_Group, Sex, Industry, Tooth_site)

# test for difference between different metadata categories 
adonis2(seed_L4_carbohydrates_noblanks.euc ~ ExtractionBatch + Village + Sex + Industry + Tooth_site + Ethnic_Group + Age_group +  LibraryBatch + Market_economy, metadata_noblanks, permutations = 999, by = "margin")

# controlled for tooth site
adonis2(seed_L4_carbohydrates_noblanks.euc ~ ExtractionBatch + Village + Sex + Industry + Ethnic_Group + Age_group +  LibraryBatch + Market_economy, metadata_noblanks, permutations = 999, by = "margin", strata = metadata_noblanks$Tooth_site)
...
rownames(seed_L4_carbohydrates_cmc) <- seed_L4_carbohydrates_cmc$SampleID
seed_L4_carbohydrates_cmc <- as.matrix(seed_L4_carbohydrates_cmc %>% 
  select(-SampleID)) + 1 # add +1 to all values to be able to do a CLR transformation before running PCA
...
seed_L4_carbohydrates_cmc.euc.vecmet <- inner_join(seed_L4_carbohydrates_cmc.euc.pcoavectors, metadata, by = "SampleID")

seed_L4_carbohydrates_cmc.euc.vecmet %>%
  ggplot(., aes(Axis.1, Axis.2, colour = Tooth_site, shape = Tooth_site)) +
  geom_point(size = 4) +
  scale_colour_manual(values = Tooth_site_colors) +
  scale_shape_manual(values = Tooth_site_shapes) +
...
# controlled for tooth site
adonis2(seed_L4_carbohydrates_cmc.euc ~ ExtractionBatch + Village + Sex + Ethnic_Group + Age_group +  LibraryBatch + Market_economy, metadata_cmc, permutations = 999, by = "margin", strata = metadata_cmc$Tooth_site)
