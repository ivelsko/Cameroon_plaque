...
adonis2(seed_L4.decontam_noblanks_33.euc ~ Village + Sex + Industry + Ethnic_Group + Age_group +  Market_economy, data = metadata_noblanks, permutations = 999, method = "euclidean", by = "margin")

# controlled for tooth site
adonis2(seed_L4.decontam_noblanks_33.pca$X ~ Village + Sex + Industry + Ethnic_Group + Age_group +  Market_economy, metadata_noblanks, permutations = 999, by = "margin", strata = metadata_noblanks_33$Tooth_site)
