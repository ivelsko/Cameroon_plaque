---
title: "Cameroon Baka/Nzime calculus/plaque SEED"
author: "Irina Velsko"
...
ggsave("./06-publication/supplemental_figures/SXX21/panel_parts/SXX21_aadder_assignment_pct.pdf", plot = seed_assignments_box,
...
ggsave("./06-publication/supplemental_figures/SXX21/panel_parts/SXX21_aadder_assignment_numbers.pdf", plot = seed_counts_box,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)
...
seed_counts_decontam_box <- seed_counts_decontam %>%
  ...
  ggplot(., aes(Village, Total_detected, fill = Village)) +
    ...
    theme_minimal(base_size = 16) +
    theme(axis.text.x = element_text(angle = 0, hjust = 0.5, size = 16)) +
    ylab("Nnumber of genes") +
    ggtitle("Number of SEED proteins remaining after filtering contaminants")
seed_counts_decontam_box

ggsave("./06-publication/supplemental_figures/SXX21/panel_parts/SXX21_aadder_assignment_numbers_decontam.pdf", plot = seed_counts_decontam_box,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)
...
seed_age <- plot_pca(seed_L4.decontam_noblanks_mr1.pca, "PC1", "PC2", "Age_group", "Age_group", "Age_group")
seed_age
seed_me <- plot_pca(seed_L4.decontam_noblanks_mr1.pca, "PC1", "PC2", "Market_economy", "Market_economy", "Market_economy")
seed_me
seed_sex <- plot_pca(seed_L4.decontam_noblanks_mr1.pca, "PC1", "PC2", "Sex", "Sex", "Sex")
seed_sex
...
ggsave("./06-publication/supplemental_figures/SXX38/panel_parts/SXX38_seed_age_pc12.pdf", plot = seed_age,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX38/panel_parts/SXX38_seed_me_pc12.pdf", plot = seed_me,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX38/panel_parts/SXX38_seed_sex_pc12.pdf", plot = seed_sex,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)
...
ggsave("./06-publication/supplemental_figures/SXX24/panel_parts/SXX24_seed_biplot_pc12.pdf", plot = pca_EG_biplot_pc1,
...
seed_age <- plot_pca(seed_L4.decontam_cmc_mr1.pca, "PC1", "PC2", "Age_group", "Age_group", "Age_group")
seed_age
seed_me <- plot_pca(seed_L4.decontam_cmc_mr1.pca, "PC1", "PC2", "Market_economy", "Market_economy", "Market_economy")
seed_me
seed_sex <- plot_pca(seed_L4.decontam_cmc_mr1.pca, "PC1", "PC2", "Sex", "Sex", "Sex")
seed_sex
...
ggsave("./06-publication/supplemental_figures/SXX38/panel_parts/SXX38_seed_cmc_age_pc12.pdf", plot = seed_age,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX38/panel_parts/SXX38_seed_cmc_me_pc12.pdf", plot = seed_me,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX38/panel_parts/SXX38_seed_cmc_sex_pc12.pdf", plot = seed_sex,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)
...
# which paths distinguish sample groups when only CMC samples are included?
pca_EG_cmc_biplot_pc1 <- plot_pca_bi(seed_L4.decontam_cmc_mr1.pca, "PC1", "PC2", "Tooth_site", PC1, pathways = F)
pca_EG_cmc_biplot_pc1

ggsave("./06-publication/supplemental_figures/SXX24/panel_parts/SXX24_seed_cmc_biplot_pc12.pdf", plot = pca_EG_cmc_biplot_pc1,
       device = "pdf", scale = 1, width = 10, height = 10, units = c("in"), dpi = 300)
...
# plot the PCA
seed_carb_eg <- plot_pca(seed_L4_carbohydrates.pca, "PC1", "PC2", "Ethnic_Group", "Ethnic_Group", "Ethnic_Group")
seed_carb_eg
seed_carb_age <- plot_pca(seed_L4_carbohydrates.pca, "PC1", "PC2", "Age_group", "Ethnic_Group", "Ethnic_Group")
seed_carb_age
seed_carb_me <- plot_pca(seed_L4_carbohydrates.pca, "PC1", "PC2", "Market_economy", "Ethnic_Group", "Ethnic_Group")
seed_carb_me
seed_carb_sex <- plot_pca(seed_L4_carbohydrates.pca, "PC1", "PC2", "Sex", "Ethnic_Group", "Ethnic_Group")
seed_carb_sex
seed_carb_ts <- plot_pca(seed_L4_carbohydrates.pca, "PC1", "PC2", "Tooth_site", "Ethnic_Group", "Ethnic_Group")
seed_carb_ts
seed_carb_village <- plot_pca(seed_L4_carbohydrates.pca, "PC1", "PC2", "Village", "Ethnic_Group", "Ethnic_Group")
seed_carb_village

ggsave("./06-publication/supplemental_figures/SXX25/panel_parts/SXX25_seed_carb_eg_pc12.pdf", plot = seed_carb_eg,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX25/panel_parts/SXX25_seed_carb_age_pc12.pdf", plot = seed_carb_age,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX25/panel_parts/SXX25_seed_carb_me_pc12.pdf", plot = seed_carb_me,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX25/panel_parts/SXX25_seed_carb_sex_pc12.pdf", plot = seed_carb_sex,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX25/panel_parts/SXX25_seed_carb_ts_pc12.pdf", plot = seed_carb_ts,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX25/panel_parts/SXX25_seed_carb_village_pc12.pdf", plot = seed_carb_village,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)
...
# plot the PCA
seed_carb_eg <- plot_pca(seed_L4_carbohydrates_cmc.pca, "PC1", "PC2", "Ethnic_Group", "Ethnic_Group", "Ethnic_Group")
seed_carb_eg
seed_carb_age <- plot_pca(seed_L4_carbohydrates_cmc.pca, "PC1", "PC2", "Age_group", "Ethnic_Group", "Ethnic_Group")
seed_carb_age
seed_carb_me <- plot_pca(seed_L4_carbohydrates_cmc.pca, "PC1", "PC2", "Market_economy", "Ethnic_Group", "Ethnic_Group")
seed_carb_me
seed_carb_sex <- plot_pca(seed_L4_carbohydrates_cmc.pca, "PC1", "PC2", "Sex", "Ethnic_Group", "Ethnic_Group")
seed_carb_sex
seed_carb_ts <- plot_pca(seed_L4_carbohydrates_cmc.pca, "PC1", "PC2", "Tooth_site", "Ethnic_Group", "Ethnic_Group")
seed_carb_ts
seed_carb_village <- plot_pca(seed_L4_carbohydrates_cmc.pca, "PC1", "PC2", "Village", "Ethnic_Group", "Ethnic_Group")
seed_carb_village

ggsave("./06-publication/supplemental_figures/SXX40/panel_parts/SXX40_seed_cmc_carb_eg_pc12.pdf", plot = seed_carb_eg,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX40/panel_parts/SXX40_seed_cmc_carb_age_pc12.pdf", plot = seed_carb_age,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX40/panel_parts/SXX40_seed_cmc_carb_me_pc12.pdf", plot = seed_carb_me,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX40/panel_parts/SXX40_seed_cmc_carb_sex_pc12.pdf", plot = seed_carb_sex,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX40/panel_parts/SXX40_seed_cmc_carb_ts_pc12.pdf", plot = seed_carb_ts,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)

ggsave("./06-publication/supplemental_figures/SXX40/panel_parts/SXX40_seed_cmc_carb_village_pc12.pdf", plot = seed_carb_village,
       device = "pdf", scale = 1, width = 6, height = 5, units = c("in"), dpi = 300)
...
ggsave("./06-publication/supplemental_figures/SXX25/panel_parts/SXX25_seed_carb_biplot_pc12.pdf", plot = pca_EG_noblanks_biplot_pc1,
       device = "pdf", scale = 1, width = 10, height = 10, units = c("in"), dpi = 300)
...
pca_EG_cmc_biplot_pc1 <- plot_pca_bi(seed_L4_carbohydrates_cmc.pca, "PC1", "PC2", "Tooth_site", PC1, pathways = F)
pca_EG_cmc_biplot_pc1

ggsave("./06-publication/supplemental_figures/SXX40/panel_parts/SXX40_seed_cmc_carb_biplot_pc12.pdf", plot = pca_EG_cmc_biplot_pc1,
       device = "pdf", scale = 1, width = 10, height = 10, units = c("in"), dpi = 300)
