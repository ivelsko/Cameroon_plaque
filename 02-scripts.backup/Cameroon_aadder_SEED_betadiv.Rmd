...
# controlled for tooth site
adonis2(seed_L4.decontam_cmc_33.euc ~ ExtractionBatch + Village + Sex + Ethnic_Group + Age_group +  LibraryBatch + Market_economy, seed_L4.decontam_cmc_33.euc.vecmet, permutations = 999, by = "margin", strata = metadata_cmc$Tooth_site)
...
# controlled for tooth site
adonis2(seed_L4.decontam_noblanks_mr1.euc ~ ExtractionBatch + Village + Sex + Industry + Ethnic_Group + Age_group +  LibraryBatch + Market_economy, seed_L4.decontam_noblanks_mr1.euc.vecmet, permutations = 999, by = "margin", strata = metadata_cmc$Tooth_site)
...
metadata_cmc <- metadata %>%
  filter(!str_detect(SampleID, "EXB|LIB|SRR|JAE")) %>%
  filter(Sample == "CMC032.B0101") %>%  # this sample has very few reads
  select(SampleID, ExtractionBatch, LibraryBatch, Village, Age_group, Market_economy, Ethnic_Group, Sex, Industry, Tooth_site)
