...
ethnicGroup_market <- metadata %>%
  filter(str_detect(SampleID, "CMC")) %>%
  mutate(Individual_ID = str_trunc(SampleID, width = 6, side = "right", ellipsis = "")) %>%
  select(Individual_ID, Ethnic_Group, Market_economy) %>%
  unique() %>%
  # filter(str_detect(Tooth_site, "Posterior")) %>%
...
plot_pca_titles(malt_species.decontam_filtered, "PC1", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "All age groups, PC1-PC2")
plot_pca_titles(malt_species.decontam_filtered, "PC3", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "All age groups, PC3-PC2")
...
# perform and plot a PCA to see how the data cluster
plot_pca_titles(malt_species.decontam_filtered, "PC1", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "no 18-29, PC1-PC2")
plot_pca_titles(malt_species.decontam_filtered, "PC3", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "no 18-29, PC3-PC2")
...
# perform and plot a PCA to see how the data cluster
plot_pca_titles(malt_species.decontam_filtered, "PC1", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "no 30-39, PC1-PC2")
plot_pca_titles(malt_species.decontam_filtered, "PC3", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "no 30-39, PC3-PC2")
...
# perform and plot a PCA to see how the data cluster
plot_pca_titles(malt_species.decontam_filtered, "PC1", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "no 40-49, PC1-PC2")
plot_pca_titles(malt_species.decontam_filtered, "PC3", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "no 40-49, PC3-PC2")
...
# perform and plot a PCA to see how the data cluster
plot_pca_titles(malt_species.decontam_filtered, "PC1", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "no 50-59, PC1-PC2")
plot_pca_titles(malt_species.decontam_filtered, "PC3", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "no 50-59, PC3-PC2")
...
# perform and plot a PCA to see how the data cluster
plot_pca_titles(malt_species.decontam_filtered, "PC1", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "no 60+, PC1-PC2")
plot_pca_titles(malt_species.decontam_filtered, "PC3", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "no 60+, PC3-PC2")
...
# perform and plot a PCA to see how the data cluster
plot_pca_titles(malt_species.decontam_filtered, "PC1", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "Posterior tooth site, all age groups, PC1-PC2")
plot_pca_titles(malt_species.decontam_filtered, "PC3", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "Posterior tooth site, all age groups, PC3-PC2")
...
# perform and plot a PCA to see how the data cluster
plot_pca_titles(malt_species.decontam_filtered, "PC1", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "Posterior tooth site, no 18-29, PC1-PC2")
plot_pca_titles(malt_species.decontam_filtered, "PC3", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "Posterior tooth site, no 18-29, PC3-PC2")
...
# perform and plot a PCA to see how the data cluster
plot_pca_titles(malt_species.decontam_filtered, "PC1", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "Posterior tooth site, no 30-39, PC1-PC2")
plot_pca_titles(malt_species.decontam_filtered, "PC3", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "Posterior tooth site, no 30-39, PC3-PC2")
...
# perform and plot a PCA to see how the data cluster
plot_pca_titles(malt_species.decontam_filtered, "PC1", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "Posterior tooth site, no 40-49, PC1-PC2")
plot_pca_titles(malt_species.decontam_filtered, "PC3", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "Posterior tooth site, no 40-49, PC3-PC2")
...
# perform and plot a PCA to see how the data cluster
plot_pca_titles(malt_species.decontam_filtered, "PC1", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "Posterior tooth site, no 50-59, PC1-PC2")
plot_pca_titles(malt_species.decontam_filtered, "PC3", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "Posterior tooth site, no 50-59, PC3-PC2")
...
# perform and plot a PCA to see how the data cluster
plot_pca_titles(malt_species.decontam_filtered, "PC1", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "Posterior tooth site, no 60+, PC1-PC2")
plot_pca_titles(malt_species.decontam_filtered, "PC3", "PC2", "Age_group", "Market_economy", "Market_economy", 3, "Posterior tooth site, no 60+, PC3-PC2")
