...
# perform and plot a PCA to see how the data cluster
# by Village
gn_ant_village <- plot_pca_titles(malt_genus.decontam_filtered, "PC1", "PC2", "Village", "Ethnic_Group", "Ethnic_Group", 3)
plot_pca_titles(malt_genus.decontam_filtered, "PC3", "PC2", "Village", "Ethnic_Group", "Ethnic_Group", 3)

ggsave("../06-publication/supplemental_figures/SXX18/panel_parts/Figure_SXX18_gn_anterior_village_pc12.pdf", plot = gn_ant_village, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)
...
# perform and plot a PCA to see how the data cluster
# by Village
gn_ant_village_cmc <- plot_pca_titles(malt_genus.decontam_filtered_cmc, "PC1", "PC2", "Village", "Ethnic_Group", "Ethnic_Group", 3)
gn_ant_village_cmc
plot_pca_titles(malt_genus.decontam_filtered_cmc, "PC3", "PC2", "Village", "Ethnic_Group", "Ethnic_Group", 3)

ggsave("../06-publication/supplemental_figures/SXX18/panel_parts/Figure_SXX18_gn_anterior_village_cmc_pc12.pdf", plot = gn_ant_village_cmc, device = "pdf",
       scale = 1, width = 7, height = 5, units = c("in"), dpi = 300)
