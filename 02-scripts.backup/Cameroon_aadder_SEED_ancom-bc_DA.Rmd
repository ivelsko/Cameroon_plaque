...
fwrite(ancom_bc_cmc_Nz_Ba, "./05-results.backup/ancomBC_seed_cmc_ethnic_group.tsv", sep = "\t", quote = F)
...
# fwrite(res_cmc, "./05-results.backup/ancomBC_seed_cmc_market_economy.tsv", sep = "\t", quote = F)
...
# fwrite(ancom_bc_cmc_Fa_FC, "./05-results.backup/ancomBC_seed_cmc_FA_FC.tsv", sep = "\t", quote = F)
...
# fwrite(ancom_bc_cmc_Fa_LR, "./05-results.backup/ancomBC_seed_cmc_FA_LR.tsv", sep = "\t", quote = F)
...
# fwrite(ancom_bc_cmc_M_F, "./05-results.backup/ancomBC_seed_cmc_sex.tsv", sep = "\t", quote = F)
