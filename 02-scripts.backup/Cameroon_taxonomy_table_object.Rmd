...
# fwrite(malt_species.decontam, "05-results.backup/malt_species_decontam.tsv", sep = "\t", quote = F)
# fwrite(malt_genus.decontam, "05-results.backup/malt_genus_decontam.tsv", sep = "\t", quote = F)
