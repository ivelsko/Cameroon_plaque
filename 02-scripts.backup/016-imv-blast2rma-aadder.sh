...
#-i /projects1/microbiome_calculus/Cameroon_plaque/04-analysis/aadder/output/*out.gz \
#-o /projects1/microbiome_calculus/Cameroon_plaque/04-analysis/aadder/rma6/ \
#-a2seed /projects1/microbiome_calculus/Cameroon_plaque/01-data/databases/megan-map-Oct2019.db \
#-a2t /projects1/microbiome_calculus/Cameroon_plaque/01-data/databases/megan-map-Oct2019.db \
#-v"
